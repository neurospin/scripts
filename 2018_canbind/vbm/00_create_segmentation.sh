...
t1_images=( `cat $1` )
i=1
for index in ${!t1_images[*]}
do
    echo "matlabbatch{$i}.spm.spatial.preproc.channel.vols = {" >> $2   
    echo \'${t1_images[$index]},1\' >> $2  
    echo  '};'  >> $2
	

    #Coregistration options
    echo "matlabbatch{$i}.spm.spatial.preproc.channel.biasreg = 0.001;
	matlabbatch{$i}.spm.spatial.preproc.channel.biasfwhm = 60;
	matlabbatch{$i}.spm.spatial.preproc.channel.write = [0 0];
	matlabbatch{$i}.spm.spatial.preproc.tissue(1).tpm = {'/i2bm/local/spm12-standalone-6685/spm12_mcr/spm12/tpm/TPM.nii,1'};
	...
	matlabbatch{$i}.spm.spatial.preproc.tissue(2).tpm = {'/i2bm/local/spm12-standalone-6685/spm12_mcr/spm12/tpm/TPM.nii,2'};
	...
	matlabbatch{$i}.spm.spatial.preproc.tissue(3).tpm = {'/i2bm/local/spm12-standalone-6685/spm12_mcr/spm12/tpm/TPM.nii,3'};
	...
	matlabbatch{$i}.spm.spatial.preproc.tissue(4).tpm = {'/i2bm/local/spm12-standalone-6685/spm12_mcr/spm12/tpm/TPM.nii,4'};
	...
	matlabbatch{$i}.spm.spatial.preproc.tissue(5).tpm = {'/i2bm/local/spm12-standalone-6685/spm12_mcr/spm12/tpm/TPM.nii,5'};
	...
	matlabbatch{$i}.spm.spatial.preproc.tissue(6).tpm = {'/i2bm/local/spm12-standalone-6685/spm12_mcr/spm12/tpm/TPM.nii,6'};
