...
def mapper(key, output_collector):
    ...
    cmd = "matlab-R2017a -nodisplay -nojvm -r 'Jenatton " + X_train_path + " ("+str(N_COMP)+")"+" ("+str(param)+") "+ output + "/ ;quit'"
...
########
    ...
    params = [('Jenatton',2**-26),('Jenatton',2**-25),('Jenatton',2**-24),('Jenatton',2**-23),('Jenatton',2**-22),\
...
#               (2**-7),(2**-6),(2**-5)]
    ...
    for set in range(50):
        ...
        # Create config file
        user_func_filename = "/home/ad247405/git/scripts/2016_pca_struct/2017/Dice_Jenatton_ed.py"
