...
NFOLDS_OUTER = 5
NFOLDS_INNER = 5
def config_filename(): return os.path.join(WD,"config_alpha_dCV.json")
def results_filename(): return os.path.join(WD,"results_dCV_5folds_allparams.xlsx")
...
def mapper(key, output_collector):
    ...
    cmd = "matlab-R2017a -nodisplay -nojvm -r 'Jenatton_3D_alpha " + X_train_path + " ("+str(N_COMP)+")"+" ("+str(alpha)+") "+" ("+str(param)+") "+ spG_path + " " + output + "/ ;quit'"
...
#              ('Jenatton',0.8,2**-1),('Jenatton',0.2,2**29),('Jenatton',0.2,2**28),('Jenatton',0.2,2**27),('Jenatton',0.2,2**26),('Jenatton',0.2,2**25),('Jenatton',0.2,2**24),('Jenatton',0.2,2**23),('Jenatton',0.2,2**22),\
#              ('Jenatton',0.2,2**21),('Jenatton',0.2,2**20),('Jenatton',0.2,2**19),('Jenatton',0.2,2**18),('Jenatton',0.2,2**17),\
#              ('Jenatton',0.2,2**16),('Jenatton',0.2,2**15),('Jenatton',0.2,2**14),('Jenatton',0.2,2**13),('Jenatton',0.2,2**12),\
#              ('Jenatton',0.2,2**11),('Jenatton',0.2,2**10),('Jenatton',0.2,2**0),('Jenatton',0.2,2**8),('Jenatton',0.2,2**7),\
#              ('Jenatton',0.2,2**6),('Jenatton',0.2,2**5),('Jenatton',0.2,2**4),('Jenatton',0.2,2**3),('Jenatton',0.2,2**2),\
#              ('Jenatton',0.2,2**1),('Jenatton',0.8,2**29),('Jenatton',0.8,2**28),('Jenatton',0.2,2**27),('Jenatton',0.2,2**26),('Jenatton',0.2,2**25),('Jenatton',0.2,2**24),('Jenatton',0.2,2**23),('Jenatton',0.2,2**22),\
#              ('Jenatton',0.2,2**21),('Jenatton',0.8,2**20),('Jenatton',0.8,2**19),('Jenatton',0.8,2**18),('Jenatton',0.8,2**17),\
#              ('Jenatton',0.8,2**16),('Jenatton',0.8,2**15),('Jenatton',0.8,2**14),('Jenatton',0.8,2**13),('Jenatton',0.8,2**12),\
#              ('Jenatton',0.8,2**11),('Jenatton',0.8,2**10),('Jenatton',0.8,2**0),('Jenatton',0.8,2**8),('Jenatton',0.8,2**7),\
#              ('Jenatton',0.8,2**6),('Jenatton',0.8,2**5),('Jenatton',0.8,2**4),('Jenatton',0.8,2**3),('Jenatton',0.8,2**2),\
#              ('Jenatton',0.8,2**1),('Jenatton',0.5,2**29),('Jenatton',0.5,2**28),('Jenatton',0.5,2**27),('Jenatton',0.2,2**26),('Jenatton',0.2,2**25),('Jenatton',0.2,2**24),('Jenatton',0.2,2**23),('Jenatton',0.2,2**22),\
#              ('Jenatton',0.5,2**21),('Jenatton',0.5,2**20),('Jenatton',0.5,2**19),('Jenatton',0.5,2**18),('Jenatton',0.8,2**17),\
#              ('Jenatton',0.5,2**16),('Jenatton',0.5,2**15),('Jenatton',0.5,2**14),('Jenatton',0.5,2**13),('Jenatton',0.8,2**12),\
#              ('Jenatton',0.5,2**11),('Jenatton',0.5,2**10),('Jenatton',0.5,2**0),('Jenatton',0.5,2**8),('Jenatton',0.8,2**7),\
#              ('Jenatton',0.5,2**6),('Jenatton',0.5,2**5),('Jenatton',0.5,2**4),('Jenatton',0.5,2**3),('Jenatton',0.8,2**2),\
#              ('Jenatton',0.5,2**1)]

    params = [('Jenatton',0.5,2**-0.18),('Jenatton',0.05,2**-0.18)]
    ...
    json.dump(config, open(os.path.join(WD, "config_alpha_dCV.json"), "w"))
