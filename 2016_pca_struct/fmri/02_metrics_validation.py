...
# -*- coding: utf-8 -*-
"""
Created on Fri Jan  6 11:48:37 2017
...
for i in range(0,5):
    frobenius_norm[0,i]= scores_cv_sparse["frob_test_fold%s" %(i)][0]
    frobenius_norm[1,i]= scores_cv_enet["frob_test_fold%s" %(i)][0]
    frobenius_norm[2,i]= scores_cv_enettv["frob_test_fold%s" %(i)][0]
