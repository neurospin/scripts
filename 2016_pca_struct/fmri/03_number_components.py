...
BASE_PATH_GRAPHNET = "/neurospin/brainomics/2016_pca_struct/fmri/2017_GraphNet_fmri_500ite/model_selectionCV"
...
X_je = np.load("/neurospin/brainomics/2016_pca_struct/fmri/2017_fmri_Jenatton/data/T_hallu.npy")
...
for cv in range(0,N_FOLDS):
    ...
    X_test_je = X_je[test_samples,:]
    X_train_je = X_je[train_samples,:]
    ...
    comp_tv = np.load('/neurospin/brainomics/2016_pca_struct/fmri/fmri_model_selection_5x5folds/model_selectionCV/'+fold+'/struct_pca_0.1_0.5_0.1/components.npz')['arr_0']
    X_transform_test_tv =np.load('/neurospin/brainomics/2016_pca_struct/fmri/fmri_model_selection_5x5folds/model_selectionCV/'+fold+'/struct_pca_0.1_0.5_0.1/X_test_transform.npz')['arr_0']
    X_transform_train_tv =np.load('/neurospin/brainomics/2016_pca_struct/fmri/fmri_model_selection_5x5folds/model_selectionCV/'+fold+'/struct_pca_0.1_0.5_0.1/X_train_transform.npz')['arr_0']

    comp_gn = np.load('/neurospin/brainomics/2016_pca_struct/fmri/2017_GraphNet_fmri_500ite/model_selectionCV/'+fold+'/graphNet_pca_0.1_0.5_0.5/components.npz')['arr_0']
    X_transform_test_gn =np.load('/neurospin/brainomics/2016_pca_struct/fmri/2017_GraphNet_fmri_500ite/model_selectionCV/'+fold+'/graphNet_pca_0.1_0.5_0.5/X_test_transform.npz')['arr_0']
    X_transform_train_gn =np.load('/neurospin/brainomics/2016_pca_struct/fmri/2017_GraphNet_fmri_500ite/model_selectionCV/'+fold+'/graphNet_pca_0.1_0.5_0.5/X_train_transform.npz')['arr_0']

    comp_je = np.load('/neurospin/brainomics/2016_pca_struct/fmri/2017_fmri_Jenatton/results/'+fold+'/Jenatton_9.5367431640625e-07/V.npy')
    X_transform_test_je =np.load('/neurospin/brainomics/2016_pca_struct/fmri/2017_fmri_Jenatton/results/'+fold+'/Jenatton_9.5367431640625e-07/U_test.npy')
    X_transform_train_je =np.load('/neurospin/brainomics/2016_pca_struct/fmri/2017_fmri_Jenatton/results/'+fold+'/Jenatton_9.5367431640625e-07/U_train.npy')
    ...
    for j in range(0,N_COMP+1):
            ...
            X_predict_train_je= predict(X_train_je,comp_je[:,:j])
            ...
            X_predict_test_je = predict(X_test_je,comp_je[:,:j])
            ...
            frobenius_reconstruction_error_test_je[cv,j] =  (np.linalg.norm(X_test_je - X_predict_test_je, 'fro'))
            ...
            frobenius_reconstruction_error_train_je[cv,j] =  (np.linalg.norm(X_train_je - X_predict_train_je, 'fro'))
            ...
            cev_train_je[cv,j] = 1 - ( (np.square(np.linalg.norm(X_train_je - X_predict_train_je, 'fro'))))  / np.square((np.linalg.norm(X_train, 'fro')))
            ...
            cev_test_je[cv,j] = 1 - ( (np.square(np.linalg.norm(X_test_je - X_predict_test_je, 'fro'))))  / np.square((np.linalg.norm(X_test, 'fro')))
...
np.save(os.path.join(OUTPUT_METRIC_PATH,"frobenius_reconstruction_error_test_gn"),frobenius_reconstruction_error_test_tv)
np.save(os.path.join(OUTPUT_METRIC_PATH,"frobenius_reconstruction_error_train_gn"),frobenius_reconstruction_error_train_tv)
...
np.save(os.path.join(OUTPUT_METRIC_PATH,"cev_test_je"),cev_test_gn)
...
INPUT_DIR_GRAPHNET = "/neurospin/brainomics/2016_pca_struct/fmri/2017_GraphNet_fmri_500ite/model_selectionCV"
INPUT_RESULTS_GRAPHNET = "/neurospin/brainomics/2016_pca_struct/fmri/2017_GraphNet_fmri_500ite/results_dCV_5folds.xlsx"
INPUT_RESULTS_JE = "/neurospin/brainomics/2016_pca_struct/fmri/2017_fmri_Jenatton/results_dCV_5folds_dense.xlsx"
INPUT_DIR_JE = "/neurospin/brainomics/2016_pca_struct/fmri/2017_fmri_Jenatton/results"
...
number_features_je = X_je.shape[1]
...
scores_cv_je = pd.read_excel(INPUT_RESULTS_JE,sheetname = 3)
...
best_je_param = pd.read_excel(INPUT_RESULTS_JE,sheetname = 2)["param_key"]
...
components_je = np.zeros((number_features_je,N_COMP,N_OUTER_FOLDS))
for i in range(5):
    ...
    components_je[:,:,i] = np.load(os.path.join(INPUT_DIR_JE,"cv0%s/all" %(i),best_je_param[i],"V.npy"))
...
je_plot= plt.plot(np.arange(1,11),dice_je,'m-s',markersize=5,label = "SSPCA")
...
plt.savefig("/neurospin/brainomics/2016_pca_struct/fmri/fmri_model_selection_5x5folds/metrics_2017/fmri_metrics+dice_index_plot.pdf", bbox_inches='tight')
