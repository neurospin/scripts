...
#  col_niglob    = c("LLV", "LLcount", "WMHV", "MBcount","BPF")
  ...
  col_niglob_full    = c("WMHV", "MBcount")
  col_clinic    = c("AGE_AT_INCLUSION", "SEX", "EDUCATION", "SYS_BP", "DIA_BP", "SMOKING", "LDL", "HOMOCYSTEIN", "HBA1C", "CRP17", "ALCOHOL")
  return(list(col_info=col_info, col_targets=col_targets, col_baselines=col_baselines, col_niglob=col_niglob, col_niglob_full=col_niglob_full, col_clinic=col_clinic))
}
