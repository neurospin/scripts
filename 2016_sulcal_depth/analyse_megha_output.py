...
if __name__ == "__main__":    
    #path = '/neurospin/brainomics/2016_sulcal_depth/megha/all_sulci_qc/tol0.02/';
    features = ['surface', 'opening', 'GM_thickness', 'length', 'depthMean', 'depthMax'];
    for i in range(len(features)):
        path = '/neurospin/brainomics/2016_sulcal_depth/megha/all_features/'+features[i]+'tol0.02/';
        print '\n'
        print '================ %s =================' % features[i]
