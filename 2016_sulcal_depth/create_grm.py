...
""" 
INPUT
directory of the genetic files which were obtained from imagen database
maf, hwe, genorate, vif, win_size, win_skip (cf readme.txt)

OUTPUT
GRM matrix save in output directory

# Uncomment the line with  *****grm-gz to produce grm in gz format for MEGHA and comment the ones with *****grm binary format for PLINK
