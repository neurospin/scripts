...
list_of_sulci_display = ['FIP', 'STs', 'SC', 'SPasup', 'SFsup', 'STsterascant', 'STsterascpost', 'SFinf']
...
if __name__ == "__main__":
    ...
    for filename in glob.glob(os.path.join(path,'*tol'+str(tol)+'.phe')):
        ...
        if sulcus_names[i] in list_of_sulci_display:
            ...
            print "Sulcus name: " + sulcus_names[i]
