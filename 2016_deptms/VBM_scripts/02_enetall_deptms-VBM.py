...
WD = "/neurospin/brainomics/2016_deptms/analysis/VBM/enetall_deptms-VBM"
WD_CLUSTER = WD.replace("/neurospin/", "/mnt/neurospin/sel-poivre/")
WD_ORIGINAL = '/neurospin/brainomics/2016_deptms/analysis/VBM/results/enettv_10000ite'
DATA_PATH = '/neurospin/brainomics/2016_deptms/analysis/VBM/data'
user_func_filename = "/home/ed203246/git/scripts/2016_deptms/VBM_scripts/02_enetall_deptms-VBM.py"
...
lambda_max_A = 11.905072894287787
...
def init():
    ...
    cv_outer_old = [cv_old[k] for k in ['cv%02d/all' % i for i in  range(NFOLDS_OUTER)]]
