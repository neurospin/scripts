...
WD = '/neurospin/brainomics/2016_deptms/analysis/Freesurfer/results/svm_rois/rois_thickness+volume_model_selection_5folds'
...
if __name__ == "__main__":
    ...
    INPUT_DATA_X = '/neurospin/brainomics/2016_deptms/analysis/Freesurfer/data/Xrois_volumes+thickness.npy'
    ...
    Xth = np.load('/neurospin/brainomics/2016_deptms/analysis/Freesurfer/data/Xrois_thickness.npy')
    Xvol = np.load('/neurospin/brainomics/2016_deptms/analysis/Freesurfer/data/Xrois_volumes.npy')
    X = np.hstack([Xth,Xvol])
    np.save(INPUT_DATA_X,X)
...
#     
    ...
    user_func_filename = "/home/ad247405/git/scripts/2016_deptms/Freesurfer_scripts/05_svm_ROI_analysis_model_selection_thickness+volume.py"
