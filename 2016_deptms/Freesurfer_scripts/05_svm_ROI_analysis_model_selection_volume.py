...
WD = '/neurospin/brainomics/2016_deptms/analysis/Freesurfer/results/svm_rois/rois_volume_model_selection_5folds'
...
if __name__ == "__main__":
    ...
    INPUT_DATA_X = '/neurospin/brainomics/2016_deptms/analysis/Freesurfer/data/Xrois_volumes.npy'
    ...
    stats = pd.read_csv(os.path.join(INPUT_DATA_STATS,"aseg_volume_all.csv"),sep='\t')
  
    stats = np.asarray(stats)
    X = stats[:,1:].astype(float)
...
#     
    ...
    user_func_filename = "/home/ad247405/git/scripts/2016_deptms/Freesurfer_scripts/05_svm_ROI_analysis_model_selection_volume.py"
