# -*- coding: utf-8 -*-
"""
Created on Mon Nov 21 09:21:55 2016
...
WD = '/neurospin/brainomics/2016_deptms/analysis/Freesurfer/results/enettv/model_selection_10folds_old_resampling'
def config_filename(): return os.path.join(WD,"config_dCV.json")
def results_filename(): return os.path.join(WD,"reduced_grid_results_dCV.xlsx")
#############################################################################
...
if __name__ == "__main__":
    ...
    #############################################################################
    #Load config file
    old_config_filename = '/neurospin/brainomics/2014_deptms/results_enettv/MRI_brain/config_less_range.json'    
    os.chdir(os.path.dirname(old_config_filename))
    config = json.load(open(old_config_filename))
    old_resampling = config["resample"]
...
#     
    ...
    for cv_outer_i, (tr_val, te) in enumerate(cv_outer):
        if cv_outer_i == 0:
            ...
            tr_val = np.array(old_resampling[cv_outer_i][0])
            te = np.array(old_resampling[cv_outer_i][1])
...
#    alphas = [.1]
    ...
    user_func_filename = "/home/ad247405/git/scripts/2016_deptms/Freesurfer_scripts/03_enettv_model_selection_old_resampling.py"
