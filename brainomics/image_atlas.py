...
def resample_atlas_harvard_oxford(ref, output,
    ...
    resample_atlas_harvard_oxford(ref="mwrc1Test_Sbj1.nii.gz", output="atlas.nii.gz")
    resample_atlas_harvard_oxford(ref="vol0000.nii.gz", output="atlas.nii.gz")
    """
    ...
    sub_arr[(sub_arr == 1)  | (sub_arr == 2)  |     # Left WM & Cortex
            ...
            (sub_arr == 3)  | (sub_arr == 14)] = 0  # Ventriculus
