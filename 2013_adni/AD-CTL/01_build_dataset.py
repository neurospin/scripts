...
INPUT_CSV = os.path.join(BASE_PATH,          "AD-CTL", "population.csv")

OUTPUT = os.path.join(BASE_PATH,             "AD-CTL")
OUTPUT_CS = os.path.join(BASE_PATH,          "AD-CTL_cs")
OUTPUT_ATLAS = os.path.join(BASE_PATH,       "AD-CTL_gtvenet")
OUTPUT_CS_ATLAS = os.path.join(BASE_PATH,    "AD-CTL_cs_gtvenet")
...
babel_mask_atlas = brainomics.image_atlas.resample_atlas_harvard_oxford(
    ...
    output=os.path.join(OUTPUT_ATLAS, "mask.nii.gz"))
...
out_im.to_filename(os.path.join(OUTPUT_ATLAS, "mask.nii.gz"))
im = nibabel.load(os.path.join(OUTPUT_ATLAS, "mask.nii.gz"))
