...
mcic_m = (clinic["DX.bl"] == "MCI") &\
       ...
       (clinic["DX.last"] == "AD") &\
       (np.logical_not(clinic["ADAS11.d800"].isnull()))
assert np.sum(mcic_m) == 80

mcic = clinic[mcic_m][['PTID', 'AGE', 'PTGENDER', "PTEDUCAT", "DX.bl", "MMSE.bl", "MMSE.d800", "ADAS11.bl", "ADAS11.d800", "ADAS13.d800"]]
mcic["DX"] = "MCIc"
print "Mean ADAS11 decrease in MCIc=", np.mean(mcic["ADAS11.bl"] - mcic["ADAS11.d800"])
# Mean MADAS11 decrease in MCIc= 4.02469135802

# CTL: CTL at bl no converion to AD
ctl_m = (clinic["DX.bl"] == "CTL") &\
        (clinic["DX.last"] == "CTL") &\
        (np.logical_not(clinic["ADAS11.d800"].isnull()))
assert np.sum(ctl_m) == 119

ctl = clinic[ctl_m][['PTID', 'AGE', 'PTGENDER', "PTEDUCAT", "DX.bl", "MMSE.bl", "MMSE.d800", "ADAS11.bl", "ADAS11.d800", "ADAS13.d800"]]
ctl["DX"] = "CTL"
print "Mean ADAS11 decrease in CTL=", np.mean(ctl["ADAS11.bl"] - ctl["ADAS11.d800"])
# Mean MADAS11 decrease in CTL= 0.0416666666667
