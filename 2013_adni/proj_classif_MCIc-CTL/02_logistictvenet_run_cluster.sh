...
qsub -I
cd /neurospin/tmp/brainomics/2013_adni/proj_classif_MCIc-CTL/logistictvenet_5cv
./job_Global_long.pbs
# 3) Run on cluster
...
exit
/neurospin/brainomics/2013_adni/proj_classif_MCIc-CTL/logistictvenet_5cv/sync_pull.sh
# Reduce
...
mapreduce.py --pbs_job --config /neurospin/tmp/brainomics/2013_adni/proj_classif_MCIc-CTL/logistictvenet_5cv/config.json


# 1) Push your file to gabriel, run:
/neurospin/tmp/brainomics/2013_adni/proj_classif_MCIc-CTL/logistictvenet_5cv/sync_push.sh
# 2) Log on gabriel:
ssh -t gabriel.intra.cea.fr "cd /neurospin/tmp/brainomics/2013_adni/proj_classif_MCIc-CTL/logistictvenet_5cv ; bash"
# 3) Run the jobs
...
/neurospin/tmp/brainomics/2013_adni/proj_classif_MCIc-CTL/logistictvenet_5cv/sync_pull.sh


# Reduce
mapreduce.py --mode reduce --config /neurospin/tmp/brainomics/2013_adni/proj_classif_MCIc-CTL/logistictvenet_5cv/config.json
...
rsync -avu /neurospin/tmp/brainomics/2013_adni/proj_classif_MCIc-CTL/logistictvenet_5cv /neurospin/brainomics/2013_adni/proj_classif_MCIc-CTL/

cd /neurospin/brainomics/2013_adni/proj_classif_MCIc-CTL/logistictvenet_5cv/
