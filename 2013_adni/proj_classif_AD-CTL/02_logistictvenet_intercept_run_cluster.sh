...
exit
# 4) Pull your file from gabriel, run
/neurospin/tmp/brainomics/2013_adni/proj_classif_AD-CTL/logistictvenet_intercept_5cv/sync_pull.sh

# Reduce limit to npy files
mapreduce.py --mode reduce --config /neurospin/tmp/brainomics/2013_adni/proj_classif_AD-CTL/logistictvenet_intercept_5cv/config.json --reduce_input /neurospin/tmp/brainomics/2013_adni/proj_classif_AD-CTL/logistictvenet_intercept_5cv/results/*/*/*.npy


cd /neurospin/tmp/brainomics/2013_adni/proj_classif_AD-CTL/logistictvenet_intercept_5cv
# rm pickle files ad tar gz ones
