...
if __name__ == "__main__":
    WD = "/neurospin/brainomics/2013_adni/MCIc-CTL_s_s"
...
#    except:
    ...
    config = dict(data=dict(X=INPUT_DATA_X, y=INPUT_DATA_y),
                  ...
                  reduce_output="MCIc-CTL_s_s.csv")
...
def plot_perf():
    ...
    INPUT = "/neurospin/brainomics/2013_adni/MCIc-CTL_s_s/MCIc-CTL_s_s.csv"
    y_col = 'recall_mean'
    x_col = 'tv'
    y_col = 'auc'
    a = 0.01
...
def build_summary():
    import pandas as pd
    config_filenane = "/neurospin/brainomics/2013_adni/MCIc-CTL_s_s/config_5cv.json"
