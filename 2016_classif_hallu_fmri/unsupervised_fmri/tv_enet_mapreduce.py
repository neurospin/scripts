...
def mapper(key, output_collector):
    ...
    T_IMA= np.load( '/neurospin/brainomics/2016_classif_hallu_fmri/unsupervised_fmri/all/mapreduce/T_IMA.npy')
    y_IMA= np.load('/neurospin/brainomics/2016_classif_hallu_fmri/unsupervised_fmri/all/mapreduce/y_IMA.npy')
    T= np.load( '/neurospin/brainomics/2016_classif_hallu_fmri/unsupervised_fmri/all/mapreduce/T_cluster1.npy')
    y= np.load( '/neurospin/brainomics/2016_classif_hallu_fmri/unsupervised_fmri/all/mapreduce/y_cluster1.npy')
...
def reducer(key, values):
    ...
    print y_true    
    print y_pred
    np.save('/neurospin/brainomics/2016_classif_hallu_fmri/toward_on/mapreduce_test2/true.npy',y_true)
    np.save('/neurospin/brainomics/2016_classif_hallu_fmri/toward_on/mapreduce_test2/pred.npy',y_pred)
...
if __name__ == "__main__":
    WD = "/neurospin/brainomics/2016_classif_hallu_fmri/unsupervised_fmri/all/mapreduce"

    INPUT_DATA_X = os.path.join(WD,'T.npy')
    INPUT_DATA_y = os.path.join(WD,'y.npy')
    INPUT_DATA_subject = os.path.join(WD,'subject.npy')
