# -*- coding: utf-8 -*-
"""
Created on Wed Dec  9 17:27:58 2015
...
f=open(os.path.join(BASE_PATH,'toward_on','Logistic_L1_L2_TV','parameters_sores.csv'),'wb')
...
out_im.to_filename(os.path.join(BASE_PATH,"toward_on","Logistic_L1_L2_TV","beta_mean.nii.gz"))
#############################################################################
  
#############################################################################

#plot acc,spe and sen while TV is increased  
data = pd.read_csv((os.path.join(BASE_PATH,'toward_on','Logistic_L1_L2_TV','parameters_sores.csv')))  
