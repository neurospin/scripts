# -*- coding: utf-8 -*-
"""
Created on Fri Dec 11 16:20:50 2015
...
f=open(os.path.join(BASE_PATH,'results','Logistic_L1_L2_TV','parameters_soresBetas.csv'),'wb')
...
#        ytrain=y[train_bool]
    ...
    return current
np.save(os.path.join(BASE_PATH,'results','Logistic_L1_L2_TV_withHC','betas_subj.npy'),coef)  
...
np.save(os.path.join(BASE_PATH,'results','Logistic_L1_L2_TV_withHC','betas_24.npy'),coef)
...
out_im.to_filename(os.path.join(BASE_PATH,"results","Logistic_L1_L2_TV_withHC","beta_mean.nii.gz"))
#############################################################################
...
data = pd.read_csv((os.path.join(BASE_PATH,'results','Logistic_L1_L2_TV_withHC','parameters_scores.csv')))  
