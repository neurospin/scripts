...
algo = algorithms.proximal.CONESTA(max_iter=1500, eps = 0.00001)
...
#test_res = list()
Agl = gl.linear_operator_from_groups(p, groups=groups, weights=weights)
algorithm = algorithms.proximal.FISTA(eps=0.000001, max_iter=20000)

L1 = [0.1,0.01,0.0001,0.00001]
L2 = [0.1,0.01, 0.0001,0.00001]
LGL = [0.1,0.01,0.0001,0.00001]
