...
sides = {'R': 'Right',
         'L': 'Left'}
PIT_INDEX = 47
filename = '/neurospin/brainomics/2016_sulcal_pits/pheno_pits/test2/'+sides[side]+'/pits_numeros/'+sides[side]+"_Pit"+str(PIT_INDEX)+"_positions.csv"
...
pits_data[df_pit.loc[s_id]['Pit_numero']] = 1
