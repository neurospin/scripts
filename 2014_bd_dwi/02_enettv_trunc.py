...
create the config file for the dataset created in 01_build_dataset_trunc.py.
"""
...
def run_all(config):
    import mapreduce
    WD = "/neurospin/brainomics/2014_bd_dwi/bd_dwi_enettv_csi_trunc"
...
if __name__ == "__main__":
    ...
    # Directory
    INPUT_DIR = "/neurospin/brainomics/2014_bd_dwi/bd_dwi_csi_trunc"
    WD = "/neurospin/brainomics/2014_bd_dwi/bd_dwi_enettv_csi_trunc"
