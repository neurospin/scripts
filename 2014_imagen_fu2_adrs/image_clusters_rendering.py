# -*- coding: utf-8 -*-
"""
Created on Wed Dec 17 17:01:12 2014
...
#    win_axial.camera(slice_quaternion=rot_quat_coronal.vector())
    ...
    #print 1
    #sys.exit(app.exec_())
    return a, [clust_mesh, brain_mesh, clust_texture, a_anat, material,
               palette, block, windows, objects]
...
if __name__ == "__main__":
    ...
    for input_dirname in options.inputs:
        ...
        brain_mesh_file = os.path.join("/neurospin/brainomics",
                                       "neuroimaging_ressources/mesh",
                                       "MNI152_T1_1mm_Bothhemi.gii")
