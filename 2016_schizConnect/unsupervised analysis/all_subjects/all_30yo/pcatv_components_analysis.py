...
INPUT_POPULATION = "/neurospin/brainomics/2016_schizConnect/analysis/all_studies/\
VBM/all_subjects_less_than_30years/population.csv"
...
for i in range(10):
    ...
    axs[i].yaxis.set_ticks(np.arange(10,50,10))
