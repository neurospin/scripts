...
all_subjects_less_than_50years/results/pcatv_scz/5_folds_all50yo_scz"
...
all_subjects_less_than_50years/data/X_scz.npy' 
...
OUTPUT_METRIC_PATH = os.path.join(BASE_PATH,"explained_variance")
INPUT_DATA_X = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies/VBM/\
all_subjects_less_than_50years/data/X_controls.npy' 
INPUT_RESULTS = os.path.join(BASE_PATH,"results","0")
...
############################################################################### 
BASE_PATH = "/neurospin/brainomics/2016_schizConnect/analysis/all_studies/VBM/\
all_subjects_less_than_50years/results/pcatv_all/5_folds_all50yo_all"
OUTPUT_METRIC_PATH = os.path.join(BASE_PATH,"explained_variance")
INPUT_DATA_X = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies/VBM/\
all_subjects_less_than_50years/data/X.npy' 
INPUT_RESULTS = os.path.join(BASE_PATH,"results","0")
...
#penalty start = 3
X = np.load(INPUT_DATA_X)[:,3:]
comp = np.load(os.path.join(INPUT_RESULTS,"struct_pca_0.1_0.1_0.5","components.npz"))['arr_0']
X_transform = np.load(os.path.join(INPUT_RESULTS,"struct_pca_0.1_0.1_0.5","X_test_transform.npz"))['arr_0']
