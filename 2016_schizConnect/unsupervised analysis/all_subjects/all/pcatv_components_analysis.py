...
INPUT_POPULATION = "/neurospin/brainomics/2016_schizConnect/analysis/all_studies/VBM/all_subjects/population.csv"
...
INPUT_RESULTS = os.path.join(BASE_PATH,"results","0")
INPUT_DATA_y = "/neurospin/brainomics/2016_schizConnect/analysis/all_studies/VBM/all_subjects/data/y.npy"
...
scores = np.load(os.path.join(INPUT_RESULTS,"struct_pca_0.1_0.8_0.1","X_test_transform.npz"))['arr_0']
