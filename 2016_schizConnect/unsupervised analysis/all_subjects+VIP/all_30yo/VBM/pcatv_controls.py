...
INPUT_DATA_X = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/VBM/all_subjects_less_than_30years/data/X_controls.npy'                     
OUTPUT_DIR = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/VBM/all_subjects_less_than_30years/results/pcatv_controls'
...
CONFIGS = [[5,"vbm_pcatv_all+VIP_controls_30yo", "config.json", True]]
N_COMP = 10
...
if __name__ == "__main__":
    ...
    y = np.ones(X.shape[0])
    shutil.copy(INPUT_DATA_X, os.path.join(OUTPUT_DIR,"vbm_pcatv_all+VIP_controls_30yo"))
    ...
    clust_utils.gabriel_make_qsub_job_files(os.path.join(OUTPUT_DIR,"vbm_pcatv_all+VIP_controls_30yo"), cmd,walltime = "250:00:00")    