...
OUTPUT_DIR = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/VBM/all_subjects/results/pcatv_scz_on_corrected_X'
...
CONFIGS = [[5,"vbm_pcatv_all+VIP_scz_1e-5", "config.json", True]]
N_COMP = 10
...
if __name__ == "__main__":
    ...
    shutil.copy(INPUT_DATA_X, os.path.join(OUTPUT_DIR,"vbm_pcatv_all+VIP_scz_1e-5"))
    shutil.copy(INPUT_MASK, os.path.join(OUTPUT_DIR,"vbm_pcatv_all+VIP_scz_1e-5"))
    ...
    sync_push_filename, sync_pull_filename, WD_CLUSTER = \
        clust_utils.gabriel_make_sync_data_files(os.path.join(OUTPUT_DIR,"vbm_pcatv_all+VIP_scz_1e-5"))
    cmd = "mapreduce.py --map  %s/config.json" % WD_CLUSTER
    clust_utils.gabriel_make_qsub_job_files(os.path.join(OUTPUT_DIR,"vbm_pcatv_all+VIP_scz_1e-5"), cmd,walltime = "250:00:00")
