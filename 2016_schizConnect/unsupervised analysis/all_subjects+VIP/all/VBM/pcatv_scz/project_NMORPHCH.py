...
pop["PC1_whole_brain"] = U_nmorph_scz[:, 0]
pop["PC2_caudate_putamen"] = U_nmorph_scz[:,1]
pop["PC3_hippocampus_amygdala"] = U_nmorph_scz[:, 2]
pop["PC4_temporal_gyrus"] = U_nmorph_scz[:, 3]
pop["PC5_frontal_orbital_cortex"] = U_nmorph_scz[:, 4]
pop["PC6_thalamus"] = U_nmorph_scz[:, 5]
pop["PC7_left_thalamus"] = U_nmorph_scz[:, 6]
pop["PC8_occipital"] = U_nmorph_scz[:, 7]
pop["PC9_superior_frontal_gyrus"] = U_nmorph_scz[:, 8]
pop["PC10_heschl_gyrus"] = U_nmorph_scz[:, 9]
...
################################################################################
output = "/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/VBM/all_subjects/results/pcatv_scz/results/projection_nmorph/PC_clinics_p_values.csv"
for key in clinic.question_id.unique():
    try:
