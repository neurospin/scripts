...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 17 09:51:57 2017
...
INPUT_BASE_DIR ='/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/results/pcatv_scz'
INPUT_MASK = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/data/mask.npy'
INPUT_DATA_X = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/data/mean_centered_by_site_all/X_scz.npy'
INPUT_DATA_A = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/data/Atv.npz'

OUTPUT_DIR = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/results/pcatv_scz'
...
CONFIGS = [[5,"pcatv_FS_scz", "config.json", True]]
N_COMP = 10
...
('struct_pca', 0.1, 0.8, 0.8),('struct_pca', 0.01, 0.5, 0.5),
('struct_pca', 0.01, 0.5, 0.8),('struct_pca', 0.01, 0.5, 0.1),
('struct_pca', 0.01, 0.1, 0.8),('struct_pca', 0.01, 0.1, 0.1),
('struct_pca', 0.01, 0.1, 0.5),('struct_pca', 0.01, 0.8, 0.1),
('struct_pca', 0.01, 0.8, 0.5),('struct_pca', 0.01, 0.8, 0.8),
("pca", 0.0, 0.0, 0.0)]
...
#    resample_index = [[tr.tolist(), te.tolist()] for tr, te in skf]
    ...
    # Create config file
    user_func_filename = "/home/ad247405/git/scripts/2016_schizConnect/unsupervised analysis/all_subjects+VIP/all/Freesurfer/00_pcatv_scz.py"

    config = dict(data=dict(X="X_scz.npy"),
                   structure="mask.npy",
                  params=PARAMS,
...
if __name__ == "__main__":
    ...
    y = np.ones(X.shape[0])
    shutil.copy(INPUT_DATA_X,  os.path.join(OUTPUT_DIR,"pcatv_FS_scz"))
    shutil.copy(INPUT_MASK,  os.path.join(OUTPUT_DIR,"pcatv_FS_scz"))
    shutil.copy(INPUT_DATA_A, os.path.join(OUTPUT_DIR,"pcatv_FS_scz"))
    ...
    WD = "/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/results/pcatv_scz/pcatv_FS_scz"
