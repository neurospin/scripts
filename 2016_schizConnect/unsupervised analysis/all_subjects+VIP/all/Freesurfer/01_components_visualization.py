...
BASE_PATH = "/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/results/pcatv_scz/pcatv_FS_scz"
MASK_PATH = "/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/results/pcatv_scz/pcatv_FS_scz/mask.npy"


comp = "struct_pca_0.1_0.1_0.1"
...
WD = os.path.join(BASE_PATH,"results","0",comp,)
...
for i in range(11):
    ...
    output_filename = os.path.join(WD,"comp%r_right.png"%(i))
    ...
    output_filename = os.path.join(WD,"comp%r_right_lateral.png"%(i))
    hemi, view = 'right', 'medial'
    ...
    output_filename = os.path.join(WD,"comp%r_left.png"%(i))
    ...
    output_filename = os.path.join(WD,"comp%r_left_lateral.png"%(i))
