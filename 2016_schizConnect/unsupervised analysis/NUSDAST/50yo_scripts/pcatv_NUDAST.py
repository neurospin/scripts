...
INPUT_BASE_DIR ='/neurospin/brainomics/2016_schizConnect/analysis/NUSDAST/VBM'
INPUT_MASK = '/neurospin/brainomics/2016_schizConnect/analysis/NUSDAST/VBM/data/data_50yo/mask.nii'   
INPUT_DATA_X = '/neurospin/brainomics/2016_schizConnect/analysis/NUSDAST/VBM/data/data_50yo/X_scz_only.npy'                     
OUTPUT_DIR = '/neurospin/brainomics/2016_schizConnect/analysis/NUSDAST/VBM/results_50yo/pcatv'
...
CONFIGS = [[5,"pcatv_NUDAST_50yo", "config.json", True]]
N_COMP = 5
...
if __name__ == "__main__":
    ...
    y = np.ones(X.shape[0])
    shutil.copy(INPUT_DATA_X, os.path.join(OUTPUT_DIR,"pcatv_NUDAST_50yo"))
    shutil.copy(INPUT_MASK, os.path.join(OUTPUT_DIR,"pcatv_NUDAST_50yo"))
    ...
    sync_push_filename, sync_pull_filename, WD_CLUSTER = \
        clust_utils.gabriel_make_sync_data_files(os.path.join(OUTPUT_DIR,"pcatv_NUDAST_50yo"))
    cmd = "mapreduce.py --map  %s/config.json" % WD_CLUSTER
    clust_utils.gabriel_make_qsub_job_files(os.path.join(OUTPUT_DIR,"pcatv_NUDAST_50yo"), cmd,walltime = "250:00:00")    