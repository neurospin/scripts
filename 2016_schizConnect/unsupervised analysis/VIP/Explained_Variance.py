...
cev = np.zeros((11))
#penalty start = 3
X = np.load(INPUT_DATA_X)[:,2:]
comp = np.load(os.path.join(INPUT_RESULTS,"struct_pca_0.1_0.8_0.8","components.npz"))['arr_0']
X_transform = np.load(os.path.join(INPUT_RESULTS,"struct_pca_0.1_0.8_0.8","X_test_transform.npz"))['arr_0']
...
OUTPUT_METRIC_PATH = os.path.join(BASE_PATH,"explained_variance")
INPUT_DATA_X = '/neurospin/brainomics/2016_schizConnect/analysis/VIP/VBM/data/X_controls.npy' 
INPUT_RESULTS = os.path.join(BASE_PATH,"results","0")
...
OUTPUT_METRIC_PATH = os.path.join(BASE_PATH,"explained_variance")
INPUT_DATA_X = '/neurospin/brainomics/2016_schizConnect/analysis/VIP/VBM/data/X.npy' 
INPUT_RESULTS = os.path.join(BASE_PATH,"results","0")
