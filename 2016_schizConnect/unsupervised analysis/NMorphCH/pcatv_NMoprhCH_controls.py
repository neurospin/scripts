...
INPUT_DATA_X = '/neurospin/brainomics/2016_schizConnect/analysis/NMorphCH/Freesurfer/data/X_controls.npy'                     
OUTPUT_DIR = '/neurospin/brainomics/2016_schizConnect/analysis/NMorphCH/Freesurfer/results/pcatv_controls'
...
CONFIGS = [[5,"FS_pcatv_NMoprhCH_controls", "config.json", True]]
N_COMP = 10
...
if __name__ == "__main__":
    ...
    y = np.ones(X.shape[0])
    shutil.copy(INPUT_DATA_X, os.path.join(OUTPUT_DIR,"FS_pcatv_NMoprhCH_controls"))
    shutil.copy(INPUT_MASK, os.path.join(OUTPUT_DIR,"FS_pcatv_NMoprhCH_controls"))
    ...
    clust_utils.gabriel_make_qsub_job_files(os.path.join(OUTPUT_DIR,"FS_pcatv_NMoprhCH_controls"), cmd,walltime = "250:00:00")    