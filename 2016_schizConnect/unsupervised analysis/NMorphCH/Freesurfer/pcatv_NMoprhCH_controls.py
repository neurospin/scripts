...
INPUT_BASE_DIR ='/neurospin/brainomics/2016_schizConnect/analysis/NMorphCH/VBM'
INPUT_MASK = '/neurospin/brainomics/2016_schizConnect/analysis/NMorphCH/VBM/data/mask.nii'   
INPUT_DATA_X = '/neurospin/brainomics/2016_schizConnect/analysis/NMorphCH/VBM/data/X_controls.npy'                     
OUTPUT_DIR = '/neurospin/brainomics/2016_schizConnect/analysis/NMorphCH/VBM/results/pcatv_controls'
...
CONFIGS = [[5,"5_folds_NMoprhCH_controls", "config.json", True]]
N_COMP = 10
...
if __name__ == "__main__":
    ...
    y = np.ones(X.shape[0])
    shutil.copy(INPUT_DATA_X, os.path.join(OUTPUT_DIR,"5_folds_NMoprhCH_controls"))
    shutil.copy(INPUT_MASK, os.path.join(OUTPUT_DIR,"5_folds_NMoprhCH_controls"))
    ...
    sync_push_filename, sync_pull_filename, WD_CLUSTER = \
        clust_utils.gabriel_make_sync_data_files(os.path.join(OUTPUT_DIR,"5_folds_NMoprhCH_controls"))
    cmd = "mapreduce.py --map  %s/config.json" % WD_CLUSTER
    clust_utils.gabriel_make_qsub_job_files(os.path.join(OUTPUT_DIR,"5_folds_NMoprhCH_controls"), cmd,walltime = "250:00:00")    