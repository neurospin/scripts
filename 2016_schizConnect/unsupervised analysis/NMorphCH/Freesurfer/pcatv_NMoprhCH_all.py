...
OUTPUT_DIR = '/neurospin/brainomics/2016_schizConnect/analysis/NMorphCH/VBM/results/pcatv_all'
...
CONFIGS = [[5,"5_folds_NMoprhCH_all", "config.json", True]]
N_COMP = 10
...
if __name__ == "__main__":
    ...
    clust_utils.gabriel_make_qsub_job_files(os.path.join(OUTPUT_DIR,"5_folds_NMoprhCH_all"), cmd,walltime = "250:00:00")    