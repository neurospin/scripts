...
# SCZ ONLY
############################################################################### 
BASE_PATH = "/neurospin/brainomics/2016_schizConnect/analysis/COBRE/VBM/results/pcatv_scz/5_folds_COBRE_scz"
OUTPUT_METRIC_PATH = os.path.join(BASE_PATH,"explained_variance")
INPUT_DATA_X = '/neurospin/brainomics/2016_schizConnect/analysis/COBRE/VBM/data/X_scz_only.npy' 
...
comp = np.load(os.path.join(INPUT_RESULTS,"struct_pca_0.1_0.8_0.5","components.npz"))['arr_0']
X_transform = np.load(os.path.join(INPUT_RESULTS,"struct_pca_0.1_0.8_0.5","X_test_transform.npz"))['arr_0']

N_COMP = comp.shape[1]
cev = np.zeros((N_COMP+1))
...
BASE_PATH = "/neurospin/brainomics/2016_schizConnect/analysis/COBRE/VBM/results/pcatv_controls/5_folds_COBRE_controls"
OUTPUT_METRIC_PATH = os.path.join(BASE_PATH,"explained_variance")
INPUT_DATA_X = '/neurospin/brainomics/2016_schizConnect/analysis/COBRE/VBM/data/X_controls.npy' 
INPUT_RESULTS = os.path.join(BASE_PATH,"results","0")
...
BASE_PATH = "/neurospin/brainomics/2016_schizConnect/analysis/COBRE/VBM/results/pcatv_all/5_folds_COBRE_all"
OUTPUT_METRIC_PATH = os.path.join(BASE_PATH,"explained_variance")
