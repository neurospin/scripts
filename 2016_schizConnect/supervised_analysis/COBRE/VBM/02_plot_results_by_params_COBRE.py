...
INPUT_CSV = "/neurospin/brainomics/2016_schizConnect/analysis/COBRE/VBM/results/enettv/enettv_model_selection_5folds_COBRE/results_dCV.xlsx"
...
plt.title('COBRE dataset: 3D voxel-based GM map - $alpha = 0.01$')
