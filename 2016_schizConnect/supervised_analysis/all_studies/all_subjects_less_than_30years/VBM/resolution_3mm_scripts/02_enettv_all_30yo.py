...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb 23 10:07:45 2017
...
WD = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies/VBM/all_subjects_less_than_30years/results/enettv/3mm_enettv_model_selection_5folds_all_30yo'
...
if __name__ == "__main__":
    WD = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies/VBM/all_subjects_less_than_30years/results/enettv/3mm_enettv_model_selection_5folds_all_30yo'    
    INPUT_DATA_X = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies/VBM/all_subjects_less_than_30years/data/X_res_3mm.npy'
    INPUT_DATA_y = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies/VBM/all_subjects_less_than_30years/data/y_res_3mm.npy'
    INPUT_MASK_PATH = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies/VBM/all_subjects_less_than_30years/data/mask_res_3mm.nii'
    INPUT_CSV = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies/VBM/all_subjects_less_than_30years/population.csv'
...
#    alphas = [.1]
    ...
    user_func_filename = "/home/ad247405/git/scripts/2016_schizConnect/supervised_analysis/all_studies/all_subjects_less_than_30years/VBM/resolution_3mm_scripts/02_enettv_all_30yo.py"
    
    config = dict(data=dict(X="X_res_3mm.npy", y="y_res_3mm.npy"),
                  params=params, resample=cv,
                  structure="mask_res_3mm.nii",
