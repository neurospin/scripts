...
#
#SVM
WD = "/neurospin/brainomics/2016_schizConnect/analysis/all_studies/VBM/all_subjects_less_than_50years/results/svm/svm_model_selection_5folds_all_50yo/model_selectionCV/all/all/0.001"
...
#Enet-TV
WD = "/neurospin/brainomics/2016_schizConnect/analysis/all_studies/VBM/all_subjects_less_than_50years/results/enettv/enettv_model_selection_5folds_all_50yo/model_selectionCV/refit/refit/0.1_0.18_0.02_0.8"
...
beta_t,t = array_utils.arr_threshold_from_norm2_ratio(beta, .99)
nilearn.plotting.plot_glass_brain(filename,colorbar=True,plot_abs=False,threshold = t,vmin = -0.0005, vmax = 0.0005)
