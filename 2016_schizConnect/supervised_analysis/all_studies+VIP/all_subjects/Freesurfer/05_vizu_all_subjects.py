...
BASE_PATH= "/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/results"
MASK_PATH = "/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/data/mask.npy"
TEMPLATE_PATH = "/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/freesurfer_template"
OUTPUT = "/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/results/enetall_all+VIP_all/weights_map"
OUTPUT_SVM = "/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/results/svm/FS_svm_all+VIP/weight_map"
...
Freesurfer/all_subjects/results/svm/FS_svm_all+VIP/model_selectionCV/all/all/1e-07"
...
#############################################################################
#Enet weight map
enet_weight_map = "/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/\
all_subjects/results/enetall_all+VIP_all/5cv/refit/refit/enet_0.01_0.1_0"
...
#Graphnet weight map
enet_weight_map = "/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/\
all_subjects/results/enetall_all+VIP_all/5cv/refit/refit/enetgn_0.01_0.1_0.8"
param = os.path.basename(enet_weight_map)
beta_path = os.path.join(enet_weight_map,"beta.npz")
enet = np.load(beta_path)['arr_0']
