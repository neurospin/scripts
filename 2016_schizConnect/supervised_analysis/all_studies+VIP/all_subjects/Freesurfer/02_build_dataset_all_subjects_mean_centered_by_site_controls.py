...
OUTPUT = os.path.join(BASE_PATH,"data","mean_centered_by_site_controls")
...
site_controls = site[y.ravel()==0]
Xtot_controls = Xtot[y.ravel()==0,:]

Xtot[site==1,:] = Xtot[site==1,:] - Xtot_controls[site_controls==1,:].mean(axis=0)
Xtot[site==2,:] = Xtot[site==2,:] - Xtot_controls[site_controls==2,:].mean(axis=0)
Xtot[site==3,:] = Xtot[site==3,:] - Xtot_controls[site_controls==3,:].mean(axis=0)
Xtot[site==4,:] = Xtot[site==4,:] - Xtot_controls[site_controls==4,:].mean(axis=0)
