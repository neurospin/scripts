...
np.save("/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/data/data_ROIs/Xrois_volumes.npy",Xv)
np.save("/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/data/data_ROIs/features.npy",features)

X = np.hstack([cov, Xv])
np.save("/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/data/data_ROIs/Xrois_vol+cov.npy",X)
np.save("/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/data/data_ROIs/y.npy",y)
...
np.save("/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/data/data_ROIs/featuresAndCov.npy",featuresAndCov)
#######################################################################################################
#######################################################################################################
#######################################################################################################
...
#Create thickness+Vol dataset
#######################################################################################################
#######################################################################################################
#######################################################################################################
X_vol = np.load("/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/data/data_ROIs/Xrois_volumes.npy")
X_th_cov = np.load("/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/data/data_ROIs/Xrois_thick+cov.npy")
Xtot = np.hstack([X_th_cov,X_vol])
np.save("/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/data/data_ROIs/Xrois_thick+vol+cov.npy",Xtot)

features_th_cov = np.load("/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/data/data_ROIs/featureThksAndCov.npy")
features_vol = np.load("/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/data/data_ROIs/features.npy")
features_tot = np.hstack([features_th_cov,features_vol])

np.save("/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/data/data_ROIs/features_thick+vol+cov.npy",features_tot)
