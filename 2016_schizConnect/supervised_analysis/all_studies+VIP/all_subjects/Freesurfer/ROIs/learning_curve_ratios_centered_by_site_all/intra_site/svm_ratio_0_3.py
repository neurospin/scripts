...
import mapreduce
WD = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects/results/learning_curve_centered_by_site_all/intra_site/ratio_0.3'
...
if __name__ == "__main__":
    ...
    user_func_filename = "/home/ad247405/git/scripts/2016_schizConnect/supervised_analysis/all_studies+VIP/all_subjects/Freesurfer/learning_curve_ratio_centered_by_site_all/intra_site/svm_ratio_0_3.py"

    config = dict(data=dict(X= os.path.join(INPUT_DATA_X), y="y.npy"),
