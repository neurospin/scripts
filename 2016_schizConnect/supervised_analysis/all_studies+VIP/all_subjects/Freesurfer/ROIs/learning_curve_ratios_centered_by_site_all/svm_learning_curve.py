...
INPUT_RESULTS_INTER = "/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/\
all_subjects/results/ROIs_analysis/mean_centered_by_site_all/volume/learning_curve/inter_site"

INPUT_RESULTS_INTRA = "/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/\
all_subjects/results/ROIs_analysis/mean_centered_by_site_all/volume/learning_curve/intra_site"
...
for i in ratio_range:
    print (i)
    results_inter = pd.read_excel(os.path.join(INPUT_RESULTS_INTER,"ratio_"+str(i),"results_dCV.xlsx"),sheetname=3)
    ...
    results_intra = pd.read_excel(os.path.join(INPUT_RESULTS_INTRA,"ratio_"+str(i),"results_dCV.xlsx"),sheetname=3)
...
plt.savefig("/neurospin/brainomics/2016_schizConnect/analysis/z.submission/learning_curve_ROIs.png")
...
plt.savefig("/neurospin/brainomics/2016_schizConnect/analysis/z.submission/learning_curve_ROIs_filled.png")
