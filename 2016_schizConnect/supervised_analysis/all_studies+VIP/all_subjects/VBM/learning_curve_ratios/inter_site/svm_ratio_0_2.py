...
WD = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/VBM/all_subjects/results/learning_curve_ratios/inter_site/ratio_0.2'
...
user_func_filename = '/home/ad247405/git/scripts/2016_schizConnect/supervised_analysis/all_studies+VIP/all_subjects/VBM/learning_curve_ratios/inter_site/svm_ratio_0_2.py'
...
def init():
    ...
    assert len(cv_outer[0][0]) == 88
    assert len(cv_outer[1][0]) == 105
    assert len(cv_outer[2][0]) == 67
    assert len(cv_outer[3][0]) == 103
