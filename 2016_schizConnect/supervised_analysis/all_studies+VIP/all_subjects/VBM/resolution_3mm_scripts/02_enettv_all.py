...
WD = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies/VBM/all_subjects/results/enettv/3mm_enettv_model_selection_5folds_all_subjects'
...
if __name__ == "__main__":
    WD = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies/VBM/all_subjects/results/enettv/3mm_enettv_model_selection_5folds_all_subjects'    
    INPUT_DATA_X = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies/VBM/all_subjects/data/X_res_3mm.npy'
    INPUT_DATA_y = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies/VBM/all_subjects/data/y_res_3mm.npy'
    INPUT_MASK_PATH = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies/VBM/all_subjects/data/mask_res_3mm.nii'
    INPUT_CSV = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies/VBM/all_subjects/population.csv'
...
#    alphas = [.1]
    ...
    user_func_filename = "/home/ad247405/git/scripts/2016_schizConnect/supervised_analysis/all_studies/all_subjects/VBM/resolution_3mm_scripts/02_enettv_all.py"
