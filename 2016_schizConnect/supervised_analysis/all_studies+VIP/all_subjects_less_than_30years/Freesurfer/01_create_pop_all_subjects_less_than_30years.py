...
assert sum(pop.site_num.values==1) == 52
assert sum(pop.site_num.values==2) == 33
assert sum(pop.site_num.values==3) == 165
assert sum(pop.site_num.values==4) == 30



assert sum(pop.dx_num.values==0) == 167
assert sum(pop.dx_num.values==1) == 113

assert sum(pop.sex_num.values==0) == 165
assert sum(pop.sex_num.values==1) == 115
