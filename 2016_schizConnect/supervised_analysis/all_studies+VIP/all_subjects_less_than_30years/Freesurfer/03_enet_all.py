...
WD = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/Freesurfer/all_subjects_less_than_30years/results/enetall_all+VIP_30yo'
...
user_func_filename = '/home/ad247405/git/scripts/2016_schizConnect/supervised_analysis/all_studies+VIP/all_subjects_less_than_30years/Freesurfer/03_enet_all.py'
...
def do_plot():
    ...
    plot_scores(input_filename, sheetnames,
                ...
                colors, linestyle,
                select=dict(a=[.001, .01, .1, 1.0], l1_ratio=[0.1, 0.5, 0.9]),
