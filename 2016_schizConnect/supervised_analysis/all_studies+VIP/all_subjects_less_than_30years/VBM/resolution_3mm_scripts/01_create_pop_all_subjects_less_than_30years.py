...
assert sum(pop.site_num.values==1) == 57
assert sum(pop.site_num.values==2) == 32
assert sum(pop.site_num.values==3) == 170



assert sum(pop.dx_num.values==0) == 155
assert sum(pop.dx_num.values==1) == 104

assert sum(pop.sex_num.values==0) == 156
