...
WD = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/VBM/all_subjects_less_than_50years/results/Leave_One_Site_Out/LOSO_svm'
...
if __name__ == "__main__":
    ...
    site = np.load("/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/VBM/all_subjects_less_than_50years/data/site.npy")
    ...
    user_func_filename = "/home/ad247405/git/scripts/2016_schizConnect/supervised_analysis/all_studies+VIP/all_subjects_less_than_50years/VBM/Leave_One_Site_Out/03_svm_all.py"
