...
WD = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/VBM/all_subjects_less_than_50years/results/Leave_One_Site_Out/LOSO_enet'
WD_CLUSTER = WD.replace("/neurospin/", "/mnt/neurospin/sel-poivre/")

DATA_PATH = '/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/VBM/all_subjects_less_than_50years/data'
user_func_filename = '/home/ad247405/git/scripts/2016_schizConnect/supervised_analysis/all_studies+VIP/all_subjects_less_than_50years/VBM/Leave_One_Site_Out/02_enet_all.py'
...
def reducer(key=None, values=None):
    ...
    paths_all = glob.glob("5cv/cv0?/all/*")
    paths_all.sort()
