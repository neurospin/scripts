...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb 10 14:13:35 2017
...
WD = '/neurospin/brainomics/2016_schizConnect/analysis/NUSDAST/Freesurfer/results/svm_without_sibling/model_selection_5folds'
...
def reducer(key, values):
    ...
    print('## Refit scores')
    print('## ------------')
    byparams = groupby_paths([p for p in paths if p.count("refit") and not p.count("refit/refit")],3) 
...
if __name__ == "__main__":
    ...
    WD = '/neurospin/brainomics/2016_schizConnect/analysis/NUSDAST/Freesurfer/results/svm_without_sibling/model_selection_5folds'    
    INPUT_DATA_X = '/neurospin/brainomics/2016_schizConnect/analysis/NUSDAST/Freesurfer/data_without_sibling/X.npy'
    INPUT_DATA_y = '/neurospin/brainomics/2016_schizConnect/analysis/NUSDAST/Freesurfer/data_without_sibling/y.npy'
    INPUT_MASK_PATH = '/neurospin/brainomics/2016_schizConnect/analysis/NUSDAST/Freesurfer/data/mask.npy'
...
#     
    ...
    user_func_filename = "/home/ad247405/git/scripts/2016_schizConnect/supervised_analysis/NUSDAST/without_sibling/04_svm_NUSDAST_without_sibling.py"
