...
INPUT_CSV = "/neurospin/brainomics/2016_schizConnect/analysis/NUSDAST/VBM/results/enettv/enettv_model_selection_5folds_NUDAST/results_dCV.xlsx"
...
plt.title('NUDAST dataset: 3D voxel-based GM map - $alpha = 1.0$')
