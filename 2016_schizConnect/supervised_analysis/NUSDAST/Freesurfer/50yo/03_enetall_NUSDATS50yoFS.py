...
WD = '/neurospin/brainomics/2016_schizConnect/analysis/NUSDAST/Freesurfer/results_50yo/enetall_NUSDATS50yoFS'
WD_CLUSTER = WD.replace("/neurospin/", "/mnt/neurospin/sel-poivre/")

DATA_PATH = '/neurospin/brainomics/2016_schizConnect/analysis/NUSDAST/Freesurfer/data/50yo'
user_func_filename = '/home/ed203246/git/scripts/2016_schizConnect/supervised_analysis/NUSDAST/Freesurfer/50yo/03_enetall_NUSDATS50yoFS.py'
...
def load_globals(config):
    ...
    assert np.allclose(Agn.get_singular_values(0), 8.9994390558194546, rtol=1e-03, atol=1e-03)
