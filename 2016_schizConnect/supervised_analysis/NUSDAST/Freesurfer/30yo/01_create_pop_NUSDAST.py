...
OUTPUT_CSV = os.path.join(BASE_PATH,"Freesurfer","population_30yo.csv")
...
assert sum(pop.dx_num.values==0) == 105
assert sum(pop.dx_num.values==1) == 60
assert sum(pop.sex_num.values==0) == 93
assert sum(pop.sex_num.values==1) == 72
