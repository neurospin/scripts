...
results/clustering_ROIs/results/thick+vol/4_clusters"
...
ax = sns.barplot(x="labels_name", y="score", hue="Feature", data=df_complete,order=["Controls","SCZ Cluster 1","SCZ Cluster 2","SCZ Cluster 3","SCZ Cluster 4"])
...
ax = sns.barplot(x="labels_name", y="age",data=df,order=["Controls","SCZ Cluster 1","SCZ Cluster 2","SCZ Cluster 3","SCZ Cluster 4"])
