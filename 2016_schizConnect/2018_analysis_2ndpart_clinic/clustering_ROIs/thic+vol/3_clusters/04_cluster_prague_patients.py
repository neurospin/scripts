...
##############################################################################
y_all = np.load("/neurospin/brainomics/2016_schizConnect/2018_analysis_2ndpart_clinic/results/clustering_ROIs/results/volume/corrected_results/data_corrected_with_prague/y_all_prague.npy")
site = np.load("/neurospin/brainomics/2016_schizConnect/2018_analysis_2ndpart_clinic/results/clustering_ROIs/results/volume/corrected_results/data_corrected_with_prague/site_all_prague.npy")
sets = np.hstack((np.zeros(567),np.ones(132)))
##############################################################################
...
results/clustering_ROIs/results/thickness/corrected_results/data_corrected_with_prague/pop_all_corrected.csv")
...
##############################################################################
pop_volume = pd.read_csv("/neurospin/brainomics/2016_schizConnect/2018_analysis_2ndpart_clinic/results/clustering_ROIs/results/volume/corrected_results/data_corrected_with_prague/pop_all_corrected.csv")
...
features_prague = features[sets==1,:]
...
print(silhouette_score(features_scz,labels_all_scz))
...
features_scz = features_prague[y_prague==1,:]
features_con = features_prague[y_prague==0,:]

labels_prague_scz = mod.predict(features_scz)
sum(labels_prague_scz==0)/42
sum(labels_prague_scz==1)/42
sum(labels_prague_scz==2)/42
