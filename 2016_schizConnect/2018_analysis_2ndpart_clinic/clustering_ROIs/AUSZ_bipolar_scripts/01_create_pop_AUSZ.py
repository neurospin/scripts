...
INPUT_CLINIC_FILENAME =  '/neurospin/brainomics/2016_AUSZ/results/Freesurfer/population.csv'
INPUT_FS = "/neurospin/brainomics/2016_AUSZ/preproc_FS/freesurfer_assembled_data_fsaverage"

OUTPUT_CSV = "/neurospin/brainomics/2016_schizConnect/2018_analysis_2ndpart_clinic/results/clustering_ROIs/data/ausz_autism/pop_ausz.csv"


# Read clinic data
clinic = pd.read_excel(INPUT_CLINIC_FILENAME)
clinic = clinic[clinic.diagnostic !=3]
...
pop = pop[['nip',"mri_path_lh","mri_path_rh","age","sex_num","dx_num","site"]]
