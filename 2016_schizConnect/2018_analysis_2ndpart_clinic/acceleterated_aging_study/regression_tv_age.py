...
WD = '/neurospin/brainomics/2016_schizConnect/2018_analysis_2ndpart_clinic/results/accelerated_aging/regression_tv_age_controls'
WD_CLUSTER = WD.replace("/neurospin/", "/mnt/neurospin/sel-poivre/")

DATA_PATH = '/neurospin/brainomics/2016_schizConnect/2018_analysis_2ndpart_clinic/results/accelerated_aging/data'
user_func_filename = '/home/ad247405/git/scripts/2016_schizConnect/2018_analysis_2ndpart_clinic/acceleterated_aging_study/regression_tv_age.py'
...
def init():
    ...
    shutil.copy(os.path.join(DATA_PATH, 'X_controls.npy'), WD)
    shutil.copy(os.path.join(DATA_PATH, 'age_controls.npy'), WD)
    ...
    ## Create config file
    os.chdir(WD)
    X = np.load("X_controls.npy")
    y = np.load("age_controls.npy")
...
#
    ...
    param_sklearn = [["linearSklearn",0,0,0]]

    #params = params_enet_tvgn + params_enet + params_ridge
    params = param_sklearn
    ...
    config = dict(data=dict(X="X_controls.npy", y="age_controls.npy"),
