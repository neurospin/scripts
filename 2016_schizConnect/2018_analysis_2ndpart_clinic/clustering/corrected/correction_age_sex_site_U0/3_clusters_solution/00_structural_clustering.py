...
results/clustering/corrected_results/correction_age_sex_site_U0/\
...
#mod.fit(U_all_scz[:,[1,2,3,4,5,6,8,9]])
...
results/clustering/corrected_results/correction_age_sex_site_U0/3_clusters_solution"
np.save(os.path.join(output,"labels_cluster.npy"),labels_all_scz)



labels_all_scz = np.load("/neurospin/brainomics/2016_schizConnect/2018_analysis_2ndpart_clinic/results/clustering/corrected_results/correction_age_sex_site_U0/3_clusters_solution/labels_cluster.npy")
#############################################################################
