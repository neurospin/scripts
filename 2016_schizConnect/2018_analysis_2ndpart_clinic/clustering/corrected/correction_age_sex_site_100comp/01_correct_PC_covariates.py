...
U_all = np.load("/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/VBM/all_subjects/results/pcatv_scz/vbm_pcatv_all+VIP_scz_100comp_1e-5/results/0/struct_pca_0.1_0.1_0.1/data/U_all.npy")
U_all_con = np.load("/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/VBM/all_subjects/results/pcatv_scz/vbm_pcatv_all+VIP_scz_100comp_1e-5/results/0/struct_pca_0.1_0.1_0.1/data/U_all_con.npy")
U_all_scz = np.load("/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/VBM/all_subjects/results/pcatv_scz/vbm_pcatv_all+VIP_scz_100comp_1e-5/results/0/struct_pca_0.1_0.1_0.1/data/U_all_scz.npy")
...
for i in range(100):
    ...
    mod = ols("U%s ~ age+sex+C(site)"%i,data = df).fit()
    res = mod.resid
    df["U%s_corr"%i] = res
    print (mod.summary())
...
results/clustering/corrected_results/correction_age_sex_site_100comp/U_scores_corrected/U_all.npy",U_all_corr)
