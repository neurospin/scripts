...
##############################################################################
U_all = np.load("/neurospin/brainomics/2016_schizConnect/2018_analysis_2ndpart_clinic/results/clustering/corrected_results/correction_age_sex_site_100comp/U_scores_corrected/U_all.npy")
...
ax = sns.barplot(x="labels_name", y="score", hue="PC", data=df_complete)
