...
results/clustering/nudast_only_clustering/correction_age_sex_site/U_scores_corrected.npy")
...
results/clustering/nudast_only_clustering/correction_age_sex_site/2_clusters_solution"
...
ax = sns.barplot(x="labels_name", y="age",data=df,order=["cluster 1","cluster 2"])
...
T, p = scipy.stats.f_oneway(df[df["labels"]==0]["age"],\
                     df[df["labels"]==1]["age"])
ax = sns.violinplot(x="labels_name", y="age", data=df,order=["cluster 1","cluster 2"])
