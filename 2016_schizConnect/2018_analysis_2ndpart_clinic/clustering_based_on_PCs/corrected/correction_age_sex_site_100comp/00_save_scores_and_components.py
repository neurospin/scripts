...
components = np.load("/neurospin/brainomics/2016_schizConnect/analysis/\
all_studies+VIP/VBM/all_subjects/results/pcatv_scz/vbm_pcatv_all+VIP_scz_100comp_1e-5/\
results/0/struct_pca_0.1_0.1_0.1/components.npz")["arr_0"]

output = "/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/VBM/\
all_subjects/results/pcatv_scz/vbm_pcatv_all+VIP_scz_100comp_1e-5/results/0/struct_pca_0.1_0.1_0.1/data"
#Save only positive components to facilitate interpretation
assert components.shape == (125959, 100)
