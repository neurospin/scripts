...
correction_age_sex_site/clusters_with_controls/3_clusters_solution/labels_cluster.npy")
...
df_stats = pd.DataFrame(columns=["def","T","p","mean Cluster 1","mean Cluster 2","mean Cluster 3"])
...
3_clusters_solution/cobre/clusters_clinics_p_values.csv"
...
for key in clinic.question_id.unique():
    try:
        ...
        df_stats.loc[df_stats.clinical_scores==key,"mean Cluster 3"] = round(df[df["labels"]==2][key].mean(),3)
...
output = "/neurospin/brainomics/2016_schizConnect/2018_analysis_2ndpart_clinic/\
results/clustering/corrected_results/correction_age_sex_site/clusters_with_controls/\
3_clusters_solution/cobre/anova"
...
output = "/neurospin/brainomics/2016_schizConnect/2018_analysis_2ndpart_clinic/\
results/clustering/corrected_results/correction_age_sex_site/clusters_with_controls/\
3_clusters_solution/cobre/all_anova_cobre_results.png"
...
output = "/neurospin/brainomics/2016_schizConnect/2018_analysis_2ndpart_clinic/\
results/clustering/corrected_results/correction_age_sex_site/clusters_with_controls/\
3_clusters_solution/cobre/significant_anova_cobre_results.png"
render_mpl_table(df, header_columns=0, col_width=2.0,output=output)
