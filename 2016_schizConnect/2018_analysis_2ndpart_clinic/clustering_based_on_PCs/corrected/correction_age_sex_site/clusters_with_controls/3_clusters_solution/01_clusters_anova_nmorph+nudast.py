...
labels_cluster = labels_cluster[site[site!=4]!=1]
assert labels_cluster.shape == (160,)
...
2_clusters_solution/nudast+nmorph/clusters_clinics_p_values.csv"
...
output = "/neurospin/brainomics/2016_schizConnect/2018_analysis_2ndpart_clinic/\
results/clustering/corrected_results/correction_age_sex_site/clusters_with_controls/\
2_clusters_solution/nudast+nmorph/anova"
