...
correction_age_sex_site/clusters_with_controls/3_clusters_solution/with_controls/labels_all.npy")
...
3_clusters_solution/with_controls/cobre"
...
for key in key_of_interest:
    ...
    T,p = scipy.stats.f_oneway(df[df["labels"]==0][key],
                         df[df["labels"]==1][key],\
                        df[df["labels"]==2][key])
    ax = sns.violinplot(x="labels_name", y=key, data=df,order=["controls","cluster 1","cluster 2","cluster 3"])
