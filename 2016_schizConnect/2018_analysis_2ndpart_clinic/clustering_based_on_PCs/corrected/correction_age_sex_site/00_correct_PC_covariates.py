...
#U_prague = np.load("/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/VBM/all_subjects/results/pcatv_scz/data/U_prague.npy")
#
#pop_prague = pd.read_csv("/neurospin/brainomics/2016_schizConnect/analysis/PRAGUE/results/VBM/population.csv")
#
#df = pd.DataFrame()
#df["age"] = pop_all["age"].values
#df["sex"] = pop_all["sex_num"].values
