...
#X_all = np.load("/neurospin/brainomics/2016_schizConnect/analysis/all_studies+VIP/VBM/all_subjects/data/data_by_site/NUSDAST/X.npy")
#
...
#
#for i in range(1,10):
#    U_all_scz[:,i] = U_all_scz[:,i] /X_all[y_all==1,:].mean(axis=1)
