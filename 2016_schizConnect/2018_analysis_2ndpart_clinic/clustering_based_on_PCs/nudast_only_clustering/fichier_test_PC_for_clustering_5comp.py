...
LABELS_DICT = {0: "cluster 1", 1: "cluster 2", 2: "cluster 3",3: "cluster 4",4: "cluster 5"}
...
ax = sns.barplot(x="labels_name", y="score", hue="PC", data=df_complete,order=["cluster 1","cluster 2","cluster 3","cluster 4","cluster 5"])
...
T,p = scipy.stats.f_oneway(df[df["labels"]==0][key],\
                     ...
                     df[df["labels"]==3][key],\
                    df[df["labels"]==4][key])
ax = sns.violinplot(x="labels_name", y=key, data=df,order=["cluster 1","cluster 2","cluster 3","cluster 4","cluster 5"])
