...
2018_analysis_2ndpart_clinic/results/clustering/non_corrected_results/4_clusters_solution/labels_cluster.npy")
...
results/clustering/non_corrected_results/4_clusters_solution"
df = pd.DataFrame()
