...
labels_cluster = np.load("/neurospin/brainomics/2016_schizConnect/2018_analysis_2ndpart_clinic/\
results/clustering_based_on_predictive_markers/results/corrected_results/2_clusters/labels_cluster.npy")
...
################################################################################
output = "/neurospin/brainomics/2016_schizConnect/2018_analysis_2ndpart_clinic/results/\
clustering_based_on_predictive_markers/results/corrected_results/2_clusters/nudast/"
...
for key in key_of_interest:
    ...
    T,p = scipy.stats.f_oneway(df[df["labels"]=='SCZ Cluster 1'][key],
                         df[df["labels"]=='SCZ Cluster 2'][key])
    ax = sns.violinplot(x="labels", y=key, data=df,order=["Controls",'SCZ Cluster 1','SCZ Cluster 2'])
