# -*- coding: utf-8 -*-
"""
Created on Fri Sep 26 17:11:13 2014
...
OUTPUT_DIR = os.path.join(DATA_PATH, 'GCA_motor_right')
if not os.path.exists(OUTPUT_DIR):
    os.makedirs(OUTPUT_DIR)

OUTPUT_FILE = os.path.join(OUTPUT_DIR, 'GCA_motor_right_images.npy')
OUTPUT_MASK = os.path.join(OUTPUT_DIR, 'GCA_motor_right_mask.nii')
...
if __name__ == "__main__":
    ...
    # fMRI images of right motor tasks
    # (directly picked up from the IMAGEN database)
    fMRI_right_PATH_list = []
    fMRI_subjects_list = []
    ...
    # Save list of subjects ID for whom we have both right motor fMRI tasks
    ...
    nb_images = len(fMRI_right_PATH_list)
    print "Found", nb_images, "images."

    # Read images in 4D volume
    images = None
    for i, filename in enumerate(fMRI_right_PATH_list):
