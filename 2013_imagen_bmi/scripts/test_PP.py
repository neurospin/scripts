...
if __name__ == "__main__":
    ...
    config = dict(data=dict(X='X.npy', z='z.npy'),
                  ...
                  reduce_output="results_test_PP.csv")
    json.dump(config, open(os.path.join(WD, "config_test.json"), "w"))
    ...
    print "mapreduce.py -m %s/config_test.json --ncore 12" % WD
    ...
    #############################################################################
    print "# Reduce"
    print "mapreduce.py -r %s/config_test.json" % WD
