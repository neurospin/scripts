# -*- coding: utf-8 -*-
"""
Created on Fri Oct  3 12:16:47 2014

@author: hl237680

Multivariate correlation between BMI and the concatenation of SNPs of interest
(22 SNPs + 41 genes) and read by the Illumina chip and the maximal depth
...
- '/neurospin/brainomics/2013_imagen_bmi/data/BMI_associated_SNPs_measures.csv'
    ...
    between {BMI-associated SNPs referenced in the literature + the 22 SNPs of
    interest referenced in the literature} and SNPs read by the Illumina
    platform
...
if __name__ == "__main__":
    ...
    # Set pathes
    WD = '/neurospin/tmp/brainomics/multivariate_bmi_assoc_sulci_1627SNPs'
    ...
    user_func_filename = os.path.join('/home/hl237680', 'gits', 'scripts',
                                      ...
                                      '04-c_multivariate_sulci_1627SNPs_BMI.py')
    ...
    config = dict(data=dict(X='X.npy', z='z.npy'),
                  ...
                  reduce_output='results_BMI_assoc_Sulci_1627SNPs.csv')
