...
- /neurospin/brainomics/2013_imagen_bmi/data/Imagen_mainSulcalMorphometry/full_sulci:
    .csv files containing relevant features for sulci of interest that are
    merged into one single dataframe (subject_id vs. same feature
    along all sulci)
...
if __name__ == "__main__":
    ...
    ## Set pathes
    WD = "/neurospin/tmp/brainomics/multivariate_bmi_full_sulci_IMAGEN"
    ...
    user_func_filename = os.path.join('/home/hl237680', 'gits', 'scripts',
                                      ...
                                      '06_multivariate_bmi_full_sulci.py')
