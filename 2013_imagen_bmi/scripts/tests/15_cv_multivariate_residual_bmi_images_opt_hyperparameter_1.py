# -*- coding: utf-8 -*-
"""
Created on Wed Jun 18 08:57:31 2014
...
if __name__ == "__main__":
    ...
    ## Set pathes
    WD = "/neurospin/tmp/brainomics/test_residual_bmi_images_opt_hyperparameter_1"
    ...
    params = [[alpha, l1_ratio] for alpha in [0.008, 0.01] for l1_ratio in np.arange(0.1, 1., .3)]
