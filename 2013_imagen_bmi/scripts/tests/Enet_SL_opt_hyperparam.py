...
if __name__ == "__main__":
    ...
    ## Set pathes
    WD = "/neurospin/tmp/brainomics/Enet_SL_opt_hyperparam_5"
    ...
    params = [[alpha, l1_ratio] for alpha in np.arange(0.01, 0.021, 0.01) for l1_ratio in np.arange(0.1, 1., .2)]
