...
"""
run /home/hl237680/gits/scripts/2013_imagen_bmi/scripts/proj_BMI_mltvar/15_cv_mltva_BMI.py
"""
if __name__ == "__main__":
    ...
    ## 2) cv idex and parameters to test
    params = [[alpha, l1_ratio] for alpha in [0.0001, 0.001, 0.0001] for l1_ratio in np.arange(0.1, 1., .1)]
    ...
    cmd = "mapreduce.py -m %s/config.json  --ncore 4" % WD_CLUSTER
