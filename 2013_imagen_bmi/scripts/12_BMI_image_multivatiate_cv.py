...
for i in alpha:
    ...
    for j in l1_ratio:
        ...
        for d, f in zip(debut, fin):
            ...
            print "Compute R2 value for one set (%d, %.3f)" % (alpha, l1_ratio)
        ...
        print "R2 moyen sur un set (%d, %.3f) : %.10f" % (alpha, l1_ratio, r2_moy)
...
print "alpha_opt = %d" %alpha_opt
l1_ratio_opt = l1_ratio[l1_ratio_ind]
print "l1_ratio_opt = %.3f" %l1_ratio_opt
