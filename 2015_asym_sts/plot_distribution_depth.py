...
if __name__ == "__main__":
    ...
    for filename in glob.glob(os.path.join(path,'*tol'+str(tol)+'.phe')):
        ...
        if i == 0:
            ...
            n, bins, patches = plt.hist(left_depth_male, number_bins, facecolor='blue', range=(a,b), normed=True)
            print "Males number:" + str(len(left_depth_male))
            n, bins, patches = plt.hist(left_depth_female, number_bins, facecolor='red', range=(a,b), alpha=.5, normed=True)
            print "Females number:" + str(len(left_depth_female))
            plt.xlabel('Depth max [mm]' ,fontsize=text_size, fontweight = 'bold', labelpad=0)
            plt.ylabel('% of subjects',fontsize=text_size, fontweight = 'bold', labelpad=0)
            ...
            n, bins, patches = plt.hist(right_depth_male, number_bins, facecolor='blue', range=(a,b), normed=True)
            n, bins, patches = plt.hist(right_depth_female, number_bins, facecolor='red', range=(a,b), alpha=.5, normed=True)
            ...
            n, bins, patches = plt.hist(asym_depth_male, number_bins, facecolor='blue', range=(a,b), normed=True)
            n, bins, patches = plt.hist(asym_depth_female, number_bins, facecolor='red', range=(a,b), alpha=.5, normed=True)
