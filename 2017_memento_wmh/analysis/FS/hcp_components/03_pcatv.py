...
INPUT_DATA_X = '/neurospin/brainomics/2017_memento/analysis/FS/data/hcp/X.npy'
...
CONFIGS = [[5,"pcatv_FS_HCP", "config.json", True]]
N_COMP = 10
...
#    resample_index = [[tr.tolist(), te.tolist()] for tr, te in skf]
    ...
    # Create config file
    user_func_filename = "/home/ad247405/git/scripts/2017_memento_wmh/analysis/FS/hcp_components/03_pcatv.py"
...
if __name__ == "__main__":
    ...
    y = np.ones(X.shape[0])
    shutil.copy(INPUT_DATA_X,  os.path.join(OUTPUT_DIR,"pcatv_FS_HCP"))
    shutil.copy(INPUT_MASK,  os.path.join(OUTPUT_DIR,"pcatv_FS_HCP"))
    shutil.copy(INPUT_DATA_A, os.path.join(OUTPUT_DIR,"pcatv_FS_HCP"))
    ...
    WD = "/neurospin/brainomics/2017_memento/analysis/FS/results/pcatv_FS_HCP"
