...
# -*- coding: utf-8 -*-
"""
Created on Fri Nov 17 11:16:58 2017
...
COMP_PATH = "/neurospin/brainomics/2017_memento/analysis/FS/results/pcatv_FS_ADNI_MCI/results/0/struct_pca_0.1_0.8_0.5/components.npz"
components = np.load(COMP_PATH)["arr_0"]
comp = "struct_pca_0.1_0.8_0.5"
...
for i in range(11):
    ...
    output_filename = os.path.join("/neurospin/brainomics/2017_memento/analysis/FS/results/pcatv_FS_ADNI_MCI/components",comp,"comp%r_right.png"%(i))
    ...
    output_filename = os.path.join("/neurospin/brainomics/2017_memento/analysis/FS/results/pcatv_FS_ADNI_MCI/components",comp,"comp%r_right_lateral.png"%(i))
    hemi, view = 'right', 'medial'
    ...
    output_filename = os.path.join("/neurospin/brainomics/2017_memento/analysis/FS/results/pcatv_FS_ADNI_MCI/components",comp,"comp%r_left.png"%(i))
    ...
    output_filename = os.path.join("/neurospin/brainomics/2017_memento/analysis/FS/results/pcatv_FS_ADNI_MCI/components",comp,"comp%r_left_lateral.png"%(i))
...
WD_CLUST = "/neurospin/brainomics/2017_memento/analysis/FS/results/pcatv_FS_all/components/1e-4/struct_pca_0.01_0.5_0.1"
