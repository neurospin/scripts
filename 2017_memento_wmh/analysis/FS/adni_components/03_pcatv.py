...
INPUT_BASE_DIR ='/neurospin/brainomics/2017_memento/analysis/FS'
INPUT_MASK = '/neurospin/brainomics/2017_memento/analysis/FS/data/mask.npy'
INPUT_DATA_X = '/neurospin/brainomics/2017_memento/analysis/FS/data/adni/X_mci_only.npy'
INPUT_DATA_A = '/neurospin/brainomics/2017_memento/analysis/FS/data/Atv.npz'

OUTPUT_DIR = '/neurospin/brainomics/2017_memento/analysis/FS/results/'
...
CONFIGS = [[5,"pcatv_FS_ADNI_MCI", "config.json", True]]
N_COMP = 10
...
#    resample_index = [[tr.tolist(), te.tolist()] for tr, te in skf]
    ...
    # Create config file
    user_func_filename = "/home/ad247405/git/scripts/2017_memento_wmh/analysis/FS/adni_components/03_pcatv.py"

    config = dict(data=dict(X="X_mci_only.npy"),
                   structure="mask.npy",
                  params=PARAMS,
...
if __name__ == "__main__":
    ...
    y = np.ones(X.shape[0])
    shutil.copy(INPUT_DATA_X,  os.path.join(OUTPUT_DIR,"pcatv_FS_ADNI_MCI","X_mci_only.npy"))
    shutil.copy(INPUT_MASK,  os.path.join(OUTPUT_DIR,"pcatv_FS_ADNI_MCI","mask.npy"))
    shutil.copy(INPUT_DATA_A, os.path.join(OUTPUT_DIR,"pcatv_FS_ADNI_MCI","Atv.npz"))
    ...
    WD = "/neurospin/brainomics/2017_memento/analysis/FS/results/pcatv_FS_ADNI_MCI"
