...
INPUT_DATA_X = '/neurospin/brainomics/2017_memento/analysis/FS/data/X.npy'
INPUT_DATA_A = '/neurospin/brainomics/2017_memento/analysis/FS/data/Atv.npz'

OUTPUT_DIR = '/neurospin/brainomics/2017_memento/analysis/FS/results_2/'
...
CONFIGS = [[5,"pcatv_FS_all", "config.json", True]]
N_COMP = 10
...
#    resample_index = [[tr.tolist(), te.tolist()] for tr, te in skf]
    ...
    # Create config file
    user_func_filename = "/home/ad247405/git/scripts/2017_memento_wmh/analysis/FS/03_pcatv.py"

    config = dict(data=dict(X="X.npy"),
                   structure="mask.npy",
                  params=PARAMS,
                  resample=resample_index,
                  map_output="results_2",
                  n_folds=n_folds,
                  structure_linear_operator_tv="Atv.npz",
                  full_resample=include_full_resample,
                  user_func=user_func_filename,
                  reduce_group_by="params",
                  reduce_output="results_2.csv")
...
if __name__ == "__main__":
    ...
    y = np.ones(X.shape[0])
    shutil.copy(INPUT_DATA_X,  os.path.join(OUTPUT_DIR,"pcatv_FS_all"))
    shutil.copy(INPUT_MASK,  os.path.join(OUTPUT_DIR,"pcatv_FS_all"))
    shutil.copy(INPUT_DATA_A, os.path.join(OUTPUT_DIR,"pcatv_FS_all"))
    ...
    WD = "/neurospin/brainomics/2017_memento/analysis/FS/results_2/pcatv_FS_all"
