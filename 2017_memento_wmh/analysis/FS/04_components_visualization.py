...
comp = "struct_pca_0.01_0.8_0.5"
COMP_PATH = os.path.join(BASE_PATH,"results_3triscotte","0",comp,"components.npz")
...
for i in range(11):
    ...
    output_filename = os.path.join("/neurospin/brainomics/2017_memento/analysis/FS/results/pcatv_FS_all/components/1e-4",comp,"comp%r_right.png"%(i))
    ...
    output_filename = os.path.join("/neurospin/brainomics/2017_memento/analysis/FS/results/pcatv_FS_all/components/1e-4",comp,"comp%r_right_lateral.png"%(i))
    hemi, view = 'right', 'medial'
    ...
    output_filename = os.path.join("/neurospin/brainomics/2017_memento/analysis/FS/results/pcatv_FS_all/components/1e-4",comp,"comp%r_left.png"%(i))
    ...
    output_filename = os.path.join("/neurospin/brainomics/2017_memento/analysis/FS/results/pcatv_FS_all/components/1e-4",comp,"comp%r_left_lateral.png"%(i))
