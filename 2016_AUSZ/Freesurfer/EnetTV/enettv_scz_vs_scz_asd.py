...
WD = '/neurospin/brainomics/2016_AUSZ/results/Freesurfer/scz_vs_scz-asd/enettv_scz_vs_scz-asd'
...
if __name__ == "__main__":
    ...
    y[y==3]=0
    y[y==2]=1
    np.save('/neurospin/brainomics/2016_AUSZ/results/Freesurfer/scz_vs_scz-asd/X.npy',X)
    np.save('/neurospin/brainomics/2016_AUSZ/results/Freesurfer/scz_vs_scz-asd/y.npy',y)
    new_X = '/neurospin/brainomics/2016_AUSZ/results/Freesurfer/scz_vs_scz-asd/X.npy'
    new_y = '/neurospin/brainomics/2016_AUSZ/results/Freesurfer/scz_vs_scz-asd/y.npy'
...
#     
    ...
    user_func_filename = "/home/ad247405/git/scripts/2016_AUSZ/Freesurfer/EnetTV/enettv_scz_vs_scz_asd.py"
