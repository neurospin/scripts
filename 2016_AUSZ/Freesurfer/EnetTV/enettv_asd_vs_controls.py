...
WD = '/neurospin/brainomics/2016_AUSZ/results/Freesurfer/asd_vs_controls/enettv_asd_vs_controls'
...
if __name__ == "__main__":
   ...
   ##########################
    ...
    X = X[y!= 3,:]
    y = y[y!= 3]
    np.save('/neurospin/brainomics/2016_AUSZ/results/Freesurfer/asd_vs_controls/X.npy',X)
    np.save('/neurospin/brainomics/2016_AUSZ/results/Freesurfer/asd_vs_controls/y.npy',y)
    new_X = '/neurospin/brainomics/2016_AUSZ/results/Freesurfer/asd_vs_controls/X.npy'
    new_y = '/neurospin/brainomics/2016_AUSZ/results/Freesurfer/asd_vs_controls/y.npy'
...
#     
    ...
    user_func_filename = '/home/ad247405/git/scripts/2016_AUSZ/Freesurfer/EnetTV/enettv_asd_vs_controls.py'
