...
WD = '/neurospin/brainomics/2016_AUSZ/results/VBM/asd_vs_controls/svm'
...
if __name__ == "__main__":
   ...
   ##########################
    ...
    X = X[y!= 3,:]
    y = y[y!= 3]
    np.save('/neurospin/brainomics/2016_AUSZ/results/VBM/asd_vs_controls/X.npy',X)
    np.save('/neurospin/brainomics/2016_AUSZ/results/VBM/asd_vs_controls/y.npy',y)
...
#     
    ...
    user_func_filename = '/home/ad247405/git/scripts/2016_AUSZ/VBM/svm/svm_asd_vs_controls.py'
