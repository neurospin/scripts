...
WD = '/neurospin/brainomics/2016_AUSZ/results/VBM/scz_vs_controls/enettv_scz_vs_controls'
...
if __name__ == "__main__":
    ...
    y = y[y!= 2]
    y[y==3]=1
    np.save('/neurospin/brainomics/2016_AUSZ/results/VBM/scz_vs_controls/X.npy',X)
    np.save('/neurospin/brainomics/2016_AUSZ/results/VBM/scz_vs_controls/y.npy',y)
    new_X = '/neurospin/brainomics/2016_AUSZ/results/VBM/scz_vs_controls/X.npy'
    new_y = '/neurospin/brainomics/2016_AUSZ/results/VBM/scz_vs_controls/y.npy'
...
#     
    ...
    user_func_filename = '/home/ad247405/git/scripts/2016_AUSZ/VBM/EnetTV/enettv_scz_vs_controls.py'
