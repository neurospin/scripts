...
WD = '/neurospin/brainomics/2016_AUSZ/results/VBM/scz_vs_controls/enettv_scz_vs_controls_10000ite'
...
def init():
    ...
    INPUT_LINEAR_OPE_PATH = '/neurospin/brainomics/2016_AUSZ/results/VBM/data/Atv.npz'
