...
if __name__ == "__main__":
    BASE_PATH =  '/neurospin/brainomics/2016_AUSZ/results/VBM'
    WD = '/neurospin/brainomics/2016_AUSZ/results/VBM/enettv/no_model_selection/scz_vs_asd'
    ...
    y = y[y!= 2]
    y[y==3]=0
    np.save('/neurospin/brainomics/2016_AUSZ/results/VBM/enettv/no_model_selection/scz_vs_asd/X.npy',X)
    np.save('/neurospin/brainomics/2016_AUSZ/results/VBM/enettv/no_model_selection/scz_vs_asd/y.npy',y)
    new_X = '/neurospin/brainomics/2016_AUSZ/results/VBM/enettv/no_model_selection/scz_vs_asd/X.npy'
    new_y = '/neurospin/brainomics/2016_AUSZ/results/VBM/enettv/no_model_selection/scz_vs_asd/y.npy'
    #############################################################################
    ## Create config file
    y = np.load(new_y)
...
#    params = [params.tolist() for params in alphal1l2tv]
    ...
    user_func_filename = '/home/ad247405/git/scripts/2016_AUSZ/EnetTV/enettv_scz_vs_asd.py'
