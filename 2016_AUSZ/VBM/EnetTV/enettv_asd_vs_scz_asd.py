...
WD = '/neurospin/brainomics/2016_AUSZ/results/VBM/scz_asd_vs_asd/enettv_scz_asd_vs_asd'
...
if __name__ == "__main__":
    ...
    y = y[y!= 0]
    y[y==2]=0
    np.save('/neurospin/brainomics/2016_AUSZ/results/VBM/scz_asd_vs_asd/X.npy',X)
    np.save('/neurospin/brainomics/2016_AUSZ/results/VBM/scz_asd_vs_asd/y.npy',y)
    new_X = '/neurospin/brainomics/2016_AUSZ/results/VBM/scz_asd_vs_asd/X.npy'
    new_y = '/neurospin/brainomics/2016_AUSZ/results/VBM/scz_asd_vs_asd/y.npy'
...
#     
    ...
    user_func_filename = '/home/ad247405/git/scripts/2016_AUSZ/VBM/EnetTV/enettv_asd_vs_scz_asd.py'
