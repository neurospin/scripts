...
WD = '/neurospin/brainomics/2016_AUSZ/september_2017/results/VBM/linear_regression_all'

INPUT_DATA_X = '/neurospin/brainomics/2016_AUSZ/september_2017/results/VBM/data/X.npy'
INPUT_DATA_y = '/neurospin/brainomics/2016_AUSZ/september_2017/results/VBM/data/y.npy'
...
plt.scatter((pred[y==0], pred[y==1], pred[y==2], pred[y==3]))
plt.plot(y, pred, 'o', label='original data')
