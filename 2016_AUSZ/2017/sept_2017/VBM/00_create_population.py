...
OUTPUT_CSV = os.path.join(BASE_PATH,"september_2017","results","VBM","population.csv")
...
assert pop_with_scores.shape == (123, 37)




# Map group
pop_with_scores['group.num'] = pop_with_scores["Groupe_x"].map(GROUP_MAP)
pop_with_scores['sex.num'] = pop_with_scores["Sexe_x"].map(GENDER_MAP)
