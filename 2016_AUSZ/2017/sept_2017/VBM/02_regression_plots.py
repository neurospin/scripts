...
BASE_PATH = "/neurospin/brainomics/2016_AUSZ/september_2017/results/VBM/linear_regression_TV_patients_MAASCtot_intercept_penalty_start"
DATA_PATH = os.path.join(BASE_PATH,"5cv")
INPUT_CSV = os.path.join(BASE_PATH,"linear_regression_TV_patients_MAASCtot_intercept_penalty_start_dcv.xlsx")
...
INPUT_DATA_DX = '/neurospin/brainomics/2016_AUSZ/september_2017/results/VBM/data/data_with_intercept/y_patients_only.npy.npy'
...
argmax_cv = argmax_cv[argmax_cv["key_refit"] == "enettv_dcv-all"]
argmax_cv = argmax_cv[argmax_cv["key_refit"] == "enet_dcv-reduced"]
...
plt.plot(true[DX==2], pred[DX==2], 'o',label = "SCZ-ASD")
