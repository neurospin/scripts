...
WD = '/neurospin/brainomics/2016_AUSZ/september_2017/results/Freesurfer/linear_regression_TV_patients_only'
WD_CLUSTER = WD.replace("/neurospin/", "/mnt/neurospin/sel-poivre/")

DATA_PATH = '/neurospin/brainomics/2016_AUSZ/september_2017/results/Freesurfer/data'
user_func_filename = '/home/ad247405/git/scripts/2016_AUSZ/2017/sept_2017/Freesurfer/regression_tv_patients.py'
...
#
    ...
    assert len(params) * len(cv) == 9504

    config = dict(data=dict(X="X_patients_only.npy", y="y_patients_only.npy"),
