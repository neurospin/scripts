...
WD = '/neurospin/brainomics/2016_AUSZ/2017/VBM/linear_regression_TV'
...
#    paths = [p for p in paths if not p.count("1.0")]
    ...
    print('## ---------------------------')
    scores_l1l2tv = scores("nestedcv", [os.path.join(config['map_output'], row["fold"], "refit", row["param_key"]) for index, row in l1l2tv[l1l2tv["fold"] != "refit"].iterrows()], config)
...
if __name__ == "__main__":
    WD = '/neurospin/brainomics/2016_AUSZ/2017/VBM/linear_regression_TV'
    INPUT_DATA_X = '/neurospin/brainomics/2016_AUSZ/2017/VBM/data/X_patients_only.npy'
    INPUT_DATA_y = '/neurospin/brainomics/2016_AUSZ/2017/VBM/data/y_patients_only.npy'
