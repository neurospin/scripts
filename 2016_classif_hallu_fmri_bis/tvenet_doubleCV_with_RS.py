# -*- coding: utf-8 -*-
"""
Created on Fri Oct 28 08:57:16 2016
...
WD = '/neurospin/brainomics/2016_classif_hallu_fmri_bis/results_nov/multivariate_analysis/enettv/with_RS_model_selection'
...
#    
    ...
    user_func_filename = os.path.join(os.environ["HOME"],
        "git", "scripts", "2016_classif_hallu_fmri_bis", "tvenet_doubleCV_with_RS.py")
