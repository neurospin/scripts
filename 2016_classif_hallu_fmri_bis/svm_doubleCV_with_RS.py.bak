# -*- coding: utf-8 -*-
"""
Created on Fri Oct 28 08:59:02 2016
...
WD = '/neurospin/brainomics/2016_classif_hallu_fmri_bis/results_nov/multivariate_analysis/svm/with_RS_model_selection'
...
if __name__ == "__main__":
    ...
    INPUT_DATA_RS_X = os.path.join(BASE_PATH,'results26/multivariate_analysis/data','T_RS.npy')
    INPUT_DATA_RS_y = os.path.join(BASE_PATH,'results26/multivariate_analysis/data','y_RS.npy')
    ...
    user_func_filename = os.path.join(os.environ["HOME"],
        "git", "scripts", "2016_classif_hallu_fmri_bis", "svm_doubleCV_with_RS.py")
