# -*- coding: utf-8 -*-
"""
Created on Mon Sep 26 12:07:00 2016

@author: ad247405
"""

'/neurospin/brainomics/2016_classif_hallu_fmri_bis/results/PCA_analysis'# -*- coding: utf-8 -*-
"""
...
INPUT_BASE_DIR ='/neurospin/brainomics/2016_classif_hallu_fmri_bis/results26'
INPUT_MASK = '/neurospin/brainomics/2016_classif_hallu_fmri_bis/results26/multivariate_analysis/data/MNI152_T1_3mm_brain_mask.nii.gz'   
INPUT_DATA_X = '/neurospin/brainomics/2016_classif_hallu_fmri_bis/results26/multivariate_analysis/data/T_hallu_only_wto_s20.npy'                     
OUTPUT_DIR = '/neurospin/brainomics/2016_classif_hallu_fmri_bis/results26/multivariate_analysis/PCA_analysis_wto_s20'
...
CONFIGS = [[5,"5_folds", "config.json", True]]
N_COMP = 5
...
def create_config(y, n_folds, output_dir, filename,
    ...
    config = dict(data=dict(X=INPUT_DATA_X),
                  params=PARAMS,
