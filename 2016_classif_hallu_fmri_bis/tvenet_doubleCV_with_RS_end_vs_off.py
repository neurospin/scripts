...
WD = '/neurospin/brainomics/2016_classif_hallu_fmri_bis/results_nov/multivariate_analysis/enettv_end_vs_off/with_RS_model_selection'
...
if __name__ == "__main__":
    BASE_PATH="/neurospin/brainomics/2016_classif_hallu_fmri_bis"
    WD = '/neurospin/brainomics/2016_classif_hallu_fmri_bis/results_nov/multivariate_analysis/enettv_end_vs_off/with_RS_model_selection'
    INPUT_DATA_X = os.path.join(BASE_PATH,'results_nov/multivariate_analysis/data','T_end_vs_off.npy')
    INPUT_DATA_y = os.path.join(BASE_PATH,'results_nov/multivariate_analysis/data','y_state_end_vs_off.npy')
    INPUT_DATA_subject = os.path.join(BASE_PATH,'results_nov/multivariate_analysis/data','subject_end_vs_off.npy')   
...
#    
    ...
    user_func_filename = os.path.join(os.environ["HOME"],
        "git", "scripts", "2016_classif_hallu_fmri_bis", "tvenet_doubleCV_with_RS_end_vs_off.py")
