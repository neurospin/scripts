...
plt.title("11th of may, Li, fid and echo acquisitions over TR on green cylinder")
plt.show()
...
plt.title("11th of may, Li, fid and echo acquisitions over different angles on green cylinder")
plt.show()
...
plt.title("6th of April, H, fid and echo acquisitions over different angles on green cylinder")
plt.show()
