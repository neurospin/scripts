# -*- coding: utf-8 -*-
"""
Created on Tue Sep  6 11:31:36 2016
...
##
## Parameters:
## in_file : a file that contains path to anatomial images "anat_list.txt"
##
## out_file : a file where the resilst will be written
##
## Then execute the R script: "01qc_tisues-volumes_spm-segmentation.R" to make a
## nice plot:
## $ R --vanilla < 01qc_tisues-volumes_spm-segmentation.R
## Then look at the file: tissues_volumes_spm-segmentation.pdf
import os
import numpy as np
...
os.chdir('/neurospin/brainomics/2016_icaar-eugei/')
in_file = os.path.join('/neurospin/brainomics/2016_icaar-eugei',"list_t1_scans_all.txt")
out_file = os.path.join('/neurospin/brainomics/2016_icaar-eugei',"tissues-volumes-globals_spm-segmentation.csv")
