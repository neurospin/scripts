# -*- coding: utf-8 -*-
"""
Created on Tue Oct 25 14:49:07 2016
...
def mapper(key, output_collector):
    ...
    proba_pred = mod.predict_proba(Xte)
...
if __name__ == "__main__":
    ...
    WD = '/neurospin/brainomics/2016_icaar-eugei/results/VBM/ICAAR+EUGEI/svm/model_selection'
    INPUT_DATA_X = '/neurospin/brainomics/2016_icaar-eugei/results/VBM/ICAAR+EUGEI/X.npy'
    INPUT_DATA_y = '/neurospin/brainomics/2016_icaar-eugei/results/VBM/ICAAR+EUGEI/y.npy'
    INPUT_MASK_PATH = '/neurospin/brainomics/2016_icaar-eugei/results/VBM/ICAAR+EUGEI/mask.nii'
    INPUT_CSV = '/neurospin/brainomics/2016_icaar-eugei/results/VBM/ICAAR+EUGEI/population.csv'
...
#                cv["refit/cvnested%02d" % (cv_inner_i)] = [tr_val[tr], tr_val[val]]
    ...
    user_func_filename = '/home/ad247405/git/scripts/2016_icaar-eugei/VBM_scripts/svm_doubleCV_icaar+eugei.py'
