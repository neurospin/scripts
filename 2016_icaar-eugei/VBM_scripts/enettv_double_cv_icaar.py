...
#WD = '/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/VBM/ICAAR/results/whole_brain/enettv/vbm_enettv_icaar_whole_brain_10000ite'
WD = '/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/VBM/ICAAR/results/whole_brain/enettv/vbm_enettv_icaar_whole_brain_500ite'
...
def plot_scores():
    ...
    blue_pal =  sns.color_palette("GnBu", 10)
    green_pal = sns.color_palette("YlGn", 10)
    red_pal = sns.color_palette("OrRd", 10)
    colors = {(0.01, 0.1):blue_pal[3],
             (0.1, 0.1):blue_pal[5],
             (1.0, 0.1):blue_pal[9],
             (0.01, 0.9):red_pal[3],
             (0.1, 0.9):red_pal[5],
    ...
    data = data[close(data.a, .01) | close(data.a, .1) | close(data.a, 1.0)]
...
if __name__ == "__main__":
    ...
    WD = '/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/VBM/ICAAR/results/whole_brain/enettv/vbm_enettv_icaar_whole_brain_10000ite'
    INPUT_DATA_X = '/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/VBM/ICAAR/data/X.npy'
    INPUT_DATA_y = '/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/VBM/ICAAR/data/y.npy'
    INPUT_MASK_PATH = '/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/VBM/ICAAR/data/mask_whole_brain.nii'
