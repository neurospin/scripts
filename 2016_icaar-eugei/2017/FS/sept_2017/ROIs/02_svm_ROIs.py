...
WD =  '/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/Freesurfer/ICAAR/results/ROIs/svm'
...
def mapper(key, output_collector):
    ...
    ret = dict(y_pred=y_pred, y_true=yte,beta=mod.coef_)
...
if __name__ == "__main__":
    WD = '/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/Freesurfer/ICAAR/results/ROIs/svm'
    INPUT_DATA_X = '/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/Freesurfer/ICAAR/data/data_ROIs/Xrois_vol+cov.npy'
    INPUT_DATA_y = '/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/Freesurfer/ICAAR/data/data_ROIs/y.npy'
