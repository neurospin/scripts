...
QC_FS_ICAAR = "/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/Freesurfer/FS_QC.xlsx"


OUTPUT_CSV_ICAAR = os.path.join(BASE_PATH,"2017_icaar_eugei","Freesurfer","ICAAR","population.csv")
