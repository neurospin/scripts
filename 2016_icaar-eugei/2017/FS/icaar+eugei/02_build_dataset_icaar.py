...
INPUT_CSV = os.path.join(BASE_PATH,"2017_icaar_eugei","Freesurfer","ICAAR+EUGEI","population.csv")
OUTPUT = os.path.join(BASE_PATH,"2017_icaar_eugei","Freesurfer","ICAAR+EUGEI","data")
