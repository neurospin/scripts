...
OUTPUT_CSV = os.path.join(BASE_PATH,"VBM","ICAAR+EUGEI","population.csv")
INPUT_DATA = "/neurospin/brainomics/2016_icaar-eugei/data/ICAAR-EUGEI/"
...
paths = glob.glob(os.path.join(INPUT_DATA,"*/*/*/*/icaar_eugei_dartel_nudast_template_mwc1*.nii"))
subjects = list()
