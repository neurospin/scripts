...
OUTPUT_DATA = "/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/VBM/ICAAR/data/data_with_scores"
...
features_CAARMS_all_names = ['sex.num','age','M0_CA1_1A',
...
features_CAARMS_severity_names = ['sex.num','age','M0_CA1_1A','M0_CA1_2A','M0_CA1_3A',
...
features_CAARMS_frequence_names = ['sex.num','age','M0_CA1_1B','M0_CA1_2B','M0_CA1_3B',
                                  'M0_CA1_4B','M0_CA2_1B',
...
assert features_CAARMS_all_scores.shape == (41,56)
assert features_CAARMS_severity_scores.shape == (41,30)
assert features_CAARMS_frequence_scores.shape == (41,28)
