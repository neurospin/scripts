...
OUTPUT_DATA = "/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/VBM/ICAAR/data/data_caarms_no_cov"
...
assert features_CAARMS_all_scores.shape == (41,54)
assert features_CAARMS_severity_scores.shape == (41,28)
assert features_CAARMS_frequence_scores.shape == (41,26)
