...
WD = '/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/VBM/ICAAR/results/CAARMS/all_CA_features/l2'
...
def mapper(key, output_collector):
    ...
    mod = estimators.RidgeLogisticRegression(l2, class_weight=class_weight, penalty_start=penalty_start)
...
if __name__ == "__main__":
    ...
    params_l2 = [[0.001], [0.01], [0.1],[0.3],[0.4],[0.5],[0.8],[1.0],[10.0]]


    user_func_filename = "/home/ad247405/git/scripts/2016_icaar-eugei/2017/VBM/sept_2017/caarms_prediction/all_CA_features/02_l2_all.py"

    config = dict(data=dict(X= os.path.basename(INPUT_DATA_X), y="y.npy"),
                  params=params_l2, resample=cv,
