...
WD = '/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/VBM/ICAAR/results/CAARMS/with_age_cov/all_CA_features/l1'
...
def mapper(key, output_collector):
    ...
    mod = estimators.LassoLogisticRegression(l1,algorithm=fista, class_weight=class_weight, penalty_start=penalty_start)
...
if __name__ == "__main__":
    WD = '/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/VBM/ICAAR/results/CAARMS/with_age_cov/all_CA_features/l1'
    INPUT_DATA_X = '/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/VBM/ICAAR/data/data_caarms_with_age_cov/X_CAARMS_all.npy'
    INPUT_DATA_y = '/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/VBM/ICAAR/data/data_caarms_with_age_cov/y.npy'
    ...
    params_l1 = [[0.001], [0.01], [0.1],[0.3],[0.4],[0.5],[0.8],[1.0],[10.0]]


    user_func_filename = "/home/ad247405/git/scripts/2016_icaar-eugei/2017/VBM/sept_2017/caarms_prediction_cov_age/all_CA_features/02_l1_all.py"

    config = dict(data=dict(X= os.path.basename(INPUT_DATA_X), y="y.npy"),
                  params=params_l1, resample=cv,
