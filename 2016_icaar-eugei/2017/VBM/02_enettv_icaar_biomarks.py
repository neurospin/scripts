...
WD = '/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/VBM/ICAAR/results/masked_brain/enettv/vbm_enettv_icaar_biomarkers'
...
def reducer(key, values):
    ...
    paths.sort()
    #paths = [p for p in paths  if os.path.basename(p).split("_")[1] != "1.0"]
...
if __name__ == "__main__":
    ...
    WD = '/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/VBM/ICAAR/results/masked_brain/enettv/vbm_enettv_icaar_biomarkers'
    INPUT_DATA_X = '/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/VBM/ICAAR/data/X_masked.npy'
    INPUT_DATA_y = '/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/VBM/ICAAR/data/y.npy'
    INPUT_MASK_PATH = '/neurospin/brainomics/2016_icaar-eugei/2017_icaar_eugei/VBM/ICAAR/data/mask_biomarkers.nii'
