...
WD = '/neurospin/brainomics/2016_icaar-eugei/september_2017/CAARMS+VBM/results/vbm+caarms_seve/svm'
...
if __name__ == "__main__":
    WD = '/neurospin/brainomics/2016_icaar-eugei/september_2017/CAARMS+VBM/results/vbm+caarms_seve/svm'
    INPUT_DATA_X = '/neurospin/brainomics/2016_icaar-eugei/september_2017/CAARMS+VBM/data/X_vbm+caarms_seve.noy.npy'
    INPUT_DATA_y = '/neurospin/brainomics/2016_icaar-eugei/september_2017/CAARMS+VBM/data/y.npy'
    INPUT_MASK_PATH = '/neurospin/brainomics/2016_icaar-eugei/september_2017/VBM/ICAAR/data/mask_whole_brain.nii'
    NFOLDS_OUTER = 5
    NFOLDS_INNER = 5
