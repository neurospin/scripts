...
OUTPUT_CSV_ICAAR = os.path.join(BASE_PATH,"results","Freesurfer","ICAAR","population.csv")
OUTPUT_CSV_ICAAR_EUGEI = os.path.join(BASE_PATH,"results","Freesurfer","ICAAR+EUGEI","population.csv")
