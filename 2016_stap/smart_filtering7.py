...
extension = '.phe'
HULL_MIN_VALUE = 40.0
DIRECTORY_PHENO = DIRECTORY_STAP+'Phenotypes/hull_filter_min'+str(HULL_MIN_VALUE)+'/'
...
df_right0 = df_right0.loc[df_right0['hullJunctionsLength']>HULL_MIN_VALUE]
...
df_left0 = df_left0.loc[df_left0['hullJunctionsLength']>HULL_MIN_VALUE]
