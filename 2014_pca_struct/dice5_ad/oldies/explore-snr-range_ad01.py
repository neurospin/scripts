# -*- coding: utf-8 -*-
"""
Created on Tue Jan 12 09:31:40 2016
...
BASE_DIR = "/neurospin/brainomics/2014_pca_struct/dice5_ad/"
...
OUTPUT_BASE_DIR = "/neurospin/brainomics/2014_pca_struct/dice5_ad/calibrate"
...
for i, snr in enumerate(dice5_data.ALL_SNRS):
    ...
    frobenius_dst[i] = np.linalg.norm(X_test - X_pred, 'fro')
