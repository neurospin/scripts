...
The file has been copied and adapted from
pylearn-parsimony/parsimony/datasets/regression/dice5.py
as of 2014-10-02 (commit 4877cc02fc00ec5cd64742ec0a0f2261e4a45761 which mostly
unrelated) and slightly modified (return the objects and some PEP8 edits).
Most changes were backported.
...
def load(n_samples=100, shape=(30, 30, 1),
    ...
    return X3d, y.reshape((n_samples, 1)), beta3d, objects
