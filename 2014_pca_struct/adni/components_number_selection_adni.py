...
config_filenane = '/neurospin/brainomics/2014_pca_struct/adni/fs_3comp_patients_only/adni_5folds/config_5folds.json'
...
for cv in (1,2,3,4,5):
    X = np.load('/neurospin/brainomics/2014_pca_struct/adni/fs_3comp_patients_only/adni_5folds/X_hallu_only.npy')
    test_samples =  config['resample'][cv][1] 
    X = X[test_samples,:]
 
    comp_sparse = np.load('/neurospin/brainomics/2014_pca_struct/adni/fs_3comp_patients_only/adni_5folds/results/%r/sparse_pca_0.0_0.0_2.0/components.npz'%(cv))['arr_0']
    X_transform_sparse =np.load('/neurospin/brainomics/2014_pca_struct/adni/fs_3comp_patients_only/adni_5folds/results/%r/sparse_pca_0.0_0.0_2.0/X_test_transform.npz'%(cv))['arr_0'] 
 
    comp_enet = np.load('/neurospin/brainomics/2014_pca_struct/adni/fs_3comp_patients_only/adni_5folds/results/%r/struct_pca_0.1_1e-06_0.1/components.npz'%(cv))['arr_0']
    X_transform_enet =np.load('/neurospin/brainomics/2014_pca_struct/adni/fs_3comp_patients_only/adni_5folds/results/%r/struct_pca_0.1_1e-06_0.1/X_test_transform.npz'%(cv))['arr_0'] 
 
    comp_tv = np.load('/neurospin/brainomics/2014_pca_struct/adni/fs_3comp_patients_only/adni_5folds/results/%r/struct_pca_0.1_0.5_0.1/components.npz'%(cv))['arr_0']
    X_transform_tv =np.load('/neurospin/brainomics/2014_pca_struct/adni/fs_3comp_patients_only/adni_5folds/results/%r/struct_pca_0.1_0.5_0.1/X_test_transform.npz'%(cv))['arr_0'] 
...
plt.savefig('/neurospin/brainomics/2014_pca_struct/adni/explained_variance_adni.pdf',format='pdf')
