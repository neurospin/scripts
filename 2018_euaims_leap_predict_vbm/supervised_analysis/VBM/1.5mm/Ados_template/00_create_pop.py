...
OUTPUT_CSV = os.path.join(BASE_PATH,"results","VBM","1.5mm","Ados_Template","population.csv")
...
subjects = list()
path_subjects= list()
paths = glob.glob(os.path.join(INPUT_DATA,"*/anatomy/mwc1*ados_template_15mm.nii"))
