...
OUTPUT_CSV = os.path.join(BASE_PATH,"results","VBM","1.5mm","Children_template","population.csv")
...
subjects = list()
path_subjects= list()
paths = glob.glob(os.path.join(INPUT_DATA,"*/anatomy/mwc1*children_template_15mm.nii"))
