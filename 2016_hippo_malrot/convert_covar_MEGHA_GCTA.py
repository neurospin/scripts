...
### INPUTS ###
megha_covar = '/neurospin/brainomics/imagen_central/clean_covar/covar_GenCitHan5PCA_hemclose_Bv_MEGHA.cov'
...
columns_covar = [u'IID',u'FID', u'Centres_Berlin',u'Centres_Dresden',
                u'Centres_Dublin', u'Centres_Hamburg',u'Centres_London',
                 u'Centres_Mannheim', u'Centres_Nottingham', u'Handness',u'SNPSEX']

gcta_qcovar = '/neurospin/brainomics/imagen_central/clean_covar/covar_5PCA_ICV_Bv_GCTA.qcov'
gcta_covar = '/neurospin/brainomics/imagen_central/clean_covar/covar_GenCitHan_GCTA.cov'
