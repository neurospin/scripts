...
### INPUTS ###
megha_covar = '/neurospin/brainomics/imagen_central/clean_covar/covar_GenCit5PCA_MEGHA.cov'
...
plink_covar = '/neurospin/brainomics/imagen_central/clean_covar/covar_GenCit5PCA_PLINK.cov'
