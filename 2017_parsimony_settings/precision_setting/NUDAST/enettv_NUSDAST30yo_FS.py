...
def config_filename(): return os.path.join(WD,"config_dCV_01.json")
...
#    np.save("/neurospin/brainomics/2017_parsimony_settings/NUSDAST_30yo/Freesurfer/start_vector.npy",start_vector)
#    np.save("/neurospin/brainomics/2017_parsimony_settings/NUSDAST_30yo/Freesurfer/start_vector1.npy",start_vector1)
#    np.save("/neurospin/brainomics/2017_parsimony_settings/NUSDAST_30yo/Freesurfer/start_vector2.npy",start_vector2)
#    np.save("/neurospin/brainomics/2017_parsimony_settings/NUSDAST_30yo/Freesurfer/start_vector3.npy",start_vector3)
#    np.save("/neurospin/brainomics/2017_parsimony_settings/NUSDAST_30yo/Freesurfer/start_vector4.npy",start_vector4)
