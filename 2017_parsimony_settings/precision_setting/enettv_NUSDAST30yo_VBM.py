...
WD = '/neurospin/brainomics/2017_parsimony_settings/NUSDAST_30yo/VBM'
WD_CLUSTER = WD.replace("/neurospin/", "/mnt/neurospin/sel-poivre/")

def config_filename(): return os.path.join(WD,"config_dCV_04.json")
...
def init():
    ...
    #start_vector1=weights.RandomUniformWeights(normalise=True,seed= 30004)
#    start_vector2 = weights.RandomUniformWeights(normalise=True,seed= 20004)
#    start_vector3 = weights.RandomUniformWeights(normalise=True,seed= 10004)
#    start_vector4 = weights.RandomUniformWeights(normalise=True,seed= 50004)
#    #np.save("/neurospin/brainomics/2017_parsimony_settings/NUSDAST_30yo/VBM/start_vector.npy",start_vector)
#    np.save("/neurospin/brainomics/2017_parsimony_settings/NUSDAST_30yo/VBM/start_vector2.npy",start_vector2)
#    np.save("/neurospin/brainomics/2017_parsimony_settings/NUSDAST_30yo/VBM/start_vector3.npy",start_vector3)
#    np.save("/neurospin/brainomics/2017_parsimony_settings/NUSDAST_30yo/VBM/start_vector4.npy",start_vector4)
#
    ...
    user_func_filename = "/home/ad247405/git/scripts/2017_parsimony_settings/enettv_NUSDAST30yo_VBM.py"

    config = dict(data=dict(X="X.npy", y="y.npy",start_vector = "start_vector4.npy"),
                  params=params,
                  structure="mask.nii",
                  structure_linear_operator_tv="Atv.npz",
                  map_output="model_selectionCV4",
                  user_func=user_func_filename,
                  reduce_input="results/*/*",
                  reduce_group_by="params",
                  reduce_output="model_selectionCV.csv")
    json.dump(config, open(os.path.join(WD, "config_dCV_04.json"), "w"))
...
def mapper(key, output_collector):
    ...
    out = os.path.join(WD,GLOBAL.DIR,"0",str(key[0])+"_"+ str(key[1]) + "_" +\
