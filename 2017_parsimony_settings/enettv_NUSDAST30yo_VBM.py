...
def init():
    ...
    #np.save("/neurospin/brainomics/2017_parsimony_settings/NUSDAST_30yo/VBM/start_vector",start_vector)
    start_vector = np.load("/neurospin/brainomics/2017_parsimony_settings/NUSDAST_30yo/VBM/start_vector.npy")
