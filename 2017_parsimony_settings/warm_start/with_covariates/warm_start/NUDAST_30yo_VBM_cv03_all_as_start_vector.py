...
WD = '/neurospin/brainomics/2017_parsimony_settings/warm_restart/NUSDAST_30yo/VBM/warm_restart/cv03_all_as_start_vector'
...
def init():
    ...
    if not os.path.exists(os.path.join(WD, "beta_start.npz")):
        betas = dict()
        BETA_START_PATH = "/neurospin/brainomics/2017_parsimony_settings/warm_restart/NUSDAST_30yo/VBM/no_warm_restart/model_selectionCV/cv03/all"
...
#
    ...
    user_func_filename = "/home/ad247405/git/scripts/2017_parsimony_settings/warm_restart/NUDAST_30yo_VBM_cv03_all_as_start_vector.py"
