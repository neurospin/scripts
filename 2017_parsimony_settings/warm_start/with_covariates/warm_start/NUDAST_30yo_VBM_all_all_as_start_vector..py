...
WD = '/neurospin/brainomics/2017_parsimony_settings/warm_restart/NUSDAST_30yo/VBM/warm_restart/all_all_as_start_vector'
...
def init():
    ...
    if not os.path.exists(os.path.join(WD, "beta_start.npz")):
        betas = dict()
        BETA_START_PATH = "/neurospin/brainomics/2017_parsimony_settings/NUSDAST_30yo/VBM/model_selectionCV0/0"
...
#
    ...
    user_func_filename = "/home/ad247405/git/scripts/2017_parsimony_settings/warm_restart/warm_restart_NUDAST_30yo_VBM.py"
...
def mapper(key, output_collector):
    ...
    algorithm_params = dict(max_iter=30000, info=info)
