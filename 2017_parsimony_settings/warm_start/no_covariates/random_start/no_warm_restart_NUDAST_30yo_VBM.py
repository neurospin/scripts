...
WD = '/neurospin/brainomics/2017_parsimony_settings/warm_restart/NUSDAST_30yo/VBM/no_covariates/no_warm_restart'
...
def mapper(key, output_collector):
    ...
    algorithm_params = dict(max_iter=100000, info=info)
    ...
    mod= estimators.LogisticRegressionL1L2TV(l1,l2,tv, A, algorithm=conesta,\
                                             ...
                                             class_weight=class_weight,start_vector=start_vector)
