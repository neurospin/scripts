...
WD = '/neurospin/brainomics/2017_parsimony_settings/warm_restart/NUSDAST_30yo/VBM/no_covariates/warm_restart/FISTA_snapshots/cv00_all_as_start_vector'
...
if __name__ == "__main__":
    ...
    if not os.path.exists(os.path.join(WD, "beta_start.npy")):
        betas = dict()
        BETA_START_PATH = "/neurospin/brainomics/2017_parsimony_settings/warm_restart/NUSDAST_30yo/VBM/no_covariates/no_warm_restart/model_selectionCV/cv00/all"
...
#
    ...
    user_func_filename = "/home/ad247405/git/scripts/2017_parsimony_settings/warm_start/no_covariates/warm_start/FISTA_snapshot/NUDAST_30yo_VBM_cv00_all_as_start_vector.py"
...
def mapper(key, output_collector):
    ...
    out_fista = os.path.join(WD,output_collector.output_dir,"fista_ite_snapshots/")
    out_conesta = os.path.join(WD,output_collector.output_dir,"conesta_ite_snapshots/")
    ...
    snapshot_conesta = AlgorithmSnapshot(out_conesta, saving_period=1).save_conesta
