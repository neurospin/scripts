...
WD = '/neurospin/brainomics/2017_parsimony_settings/warm_restart/NUSDAST_30yo/VBM/no_covariates/warm_restart/cv03_all_as_start_vector'
...
if __name__ == "__main__":
    ...
    if not os.path.exists(os.path.join(WD, "beta_start.npy")):
        betas = dict()
        BETA_START_PATH = "/neurospin/brainomics/2017_parsimony_settings/warm_restart/NUSDAST_30yo/VBM/no_covariates/no_warm_restart/model_selectionCV/cv03/all"
...
#
    ...
    user_func_filename = "/home/ad247405/git/scripts/2017_parsimony_settings/warm_start/no_covariates/warm_start/NUDAST_30yo_VBM_cv03_all_as_start_vector.py"
